...
<html lang="en">
  ...
  <body class="vertical  light  ">
    <div class="wrapper">
          ...
          <li class="nav-item w-100">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/Profil/TambahPengguna"><span class="ml-1 item-text">Tambah Pengguna</span></a>
                </li>
                <li class="nav-item">
      ...
      <h2 style="text-align:center;">Ini adalah halaman Barang Keluar</h2>
