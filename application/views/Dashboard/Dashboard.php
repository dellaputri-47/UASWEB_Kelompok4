...
$sembako =  $barang['sembako']->persen;
$makanan = $barang['makanan']->persen;
$minuman = $barang['minuman']->persen;
$persabunan = $barang['persabunan']->persen;
$peralatan = $barang['peralatan']->persen;
$elektronik = $barang['elektronik']->persen;
$pupuk = $barang['pupuk']->persen;
$alatbangunan = $barang['alatbangunan']->persen;
$obat = $barang['obat']->persen;



$dataPoints = array(
  array("label" => "Sembako", "y" => $sembako),
  array("label" => "Makanan", "y" => $makanan),
  array("label" => "Minuman", "y" => $minuman),
  array("label" => "Persabunan", "y" => $persabunan),
  array("label" => "Peralatan Rumah", "y" => $peralatan),
  array("label" => "Elektronik", "y" => $elektronik),
  array("label" => "Pupuk", "y" => $pupuk),
  array("label" => "Pertukangan", "y" => $alatbangunan),
  array("label" => "Obat-obatan", "y" => $obat)
)
?>
...
<body class="vertical  light  ">
          ...
          <div class="row">
            <div class="card shadow eq-card mb-4">
              <div class="card-body">
                ...
                <h4 class="text-center mb-5" id="Jam"></h4>
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            <script type="text/javascript">
              ...
              // letakkan data tanggal dan ppm untuk grafik
              var data = {
                labels: [
                  <?php
                ...
                datasets: [{
                    ...
                    data: [
                      <?php
                      while ($data_minuman = mysqli_fetch_array($barang['jminuman'])) {
                        echo $data_minuman['jumlah_barang'] . ',';
                      }
                      ?>
                    ]
                  },
              ...
              // cetak kedalam grafik kedalam canvas
  ...
  <script language="JavaScript">
    ...
    document.getElementById("Jam").innerHTML = hariarray[hari] + " " + tanggal + " " + bulanarray[bulan] + " " + tahun;
  </script>
