...
<html lang="en">
  ...
  <body class="vertical  light  ">
    <div class="wrapper">
          ...
          <li class="nav-item w-100">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/Profle/ResetPassword"><span class="ml-1 item-text">Reset Password</span></a>
                </li>
      ...
      <h2 style="text-align:center;">Ini adalah halaman Profil</h2>
