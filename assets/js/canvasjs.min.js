...
(function () {
  ...
  function fb(h, m) {
    ...
    for (0 > r && (r += v); r < v; r++) if (r in this && this[r] === h) return r;
    return -1;
  }
  function r(h) {
  ...
  function ib(h) {
    if (h._menuButton) h.exportEnabled ? (P(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), (h._menuButton.title = h._cultureInfo.menuText)) : ta(h._menuButton);
      ...
      J(
        ...
        function () {
          m ||
            (P(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }),
            0 >= navigator.userAgent.search("MSIE") && P(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
        },
        h.allDOMEventHandlers,
        !0
      );
      J(
        ...
        function () {
          m ||
            (P(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && P(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
        },
        h.allDOMEventHandlers,
        !0
      );
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (var v = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], pa = 0; pa < v.length; pa++)
        P(v[pa], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (v[pa].innerHTML = r[pa]);
    } else
      !h._dropdownMenu &&
        h.exportEnabled &&
        w &&
  ...
  function Ma(h, m, v) {
    if (w && ab) {
      ...
      h.width = m * ga;
      h.height = v * ga;
      Sa !== Na && ((h.style.width = m + "px"), (h.style.height = v + "px"), r.scale(ga, ga));
  ...
  function jb(h) {
    if (!kb) {
      var m = !1,
        v = !1;
      "undefined" === typeof oa.Chart.creditHref ? ((h.creditHref = W("iuuqr;..b`ow`rkr/bnl.")), (h.creditText = W("B`ow`rKR/bnl"))) : ((m = h.updateOption("creditText")), (v = h.updateOption("creditHref")));
  ...
  function ua(h, m, v) {
    m.getAttribute("state") ||
      ((m.style.backgroundColor = h.toolbar.itemBackgroundColor), (m.style.color = h.toolbar.fontColor), (m.style.border = "none"), P(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
    m.getAttribute("state") !== v &&
      (m.setAttribute("state", v),
      m.setAttribute("type", "button"),
      P(m, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
      m.setAttribute("title", h._cultureInfo[v + "Text"]),
      (m.innerHTML = "<img src='" + lb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />"),
      P(m.childNodes[0], { height: "95%", pointerEvents: "none" }));
  }
  function La() {
  ...
  function Ta(h, m, v, r, w) {
    if (null === h || "undefined" === typeof h) return "undefined" === typeof v ? m : v;
  ...
  function ba(h, m, v, w, pa) {
    ...
    h = {};
    this.theme && r(this.parent) && r(m) && r(w)
      ? (h = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[m] &&
        (null === w ? (h = this.parent.themeOptions[m]) : 0 < this.parent.themeOptions[m].length && ((w = Math.min(this.parent.themeOptions[m].length - 1, w)), (h = this.parent.themeOptions[m][w])));
    this.themeOptions = h;
  ...
  function Ua(h, m) {
    Ua.base.constructor.call(this, "Toolbar", "toolbar", m, null, h);
    this.chart = h;
  ...
  function ya(h, m) {
    ...
    if (r(this.options.margin) && h.options.subtitles)
      for (var v = h.options.subtitles, w = 0; w < v.length; w++)
        if (
          ((r(v[w].horizontalAlign) && "center" === this.horizontalAlign) || v[w].horizontalAlign === this.horizontalAlign) &&
          ((r(v[w].verticalAlign) && "top" === this.verticalAlign) || v[w].verticalAlign === this.verticalAlign) &&
  ...
  function Ia(h, m, v) {
    Ia.base.constructor.call(this, "Subtitle", "subtitles", m, v, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
  ...
  var ca = 20,
    ...
    bb = {
      colorSet: "colorSet2",
      title: { fontFamily: x, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
  ...
  Fa = {
    ...
    data: [{ indexLabelFontFamily: x, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
    axisX: [
      {
        titleFontFamily: x,
        titleFontSize: ca,
  ...
  var ca = 20,
      ...
      for (S = E = K = J = N = 0; 0 < M.length; )
        if (((m = M.pop()), "#" === m || "0" === m))
          if ((N++, N === Q)) {
            var $ = F,
              F = [];
            if ("0" === m) for (m = Q - J - ($ ? $.length : 0); 0 < m; ) $.unshift("0"), m--;
            for (; 0 < $.length; ) (v = $.pop() + v), S++, 0 === S % E && K === T && 0 < $.length && (v = x + v);
          } else 0 < F.length ? ((v = F.pop() + v), J++, S++) : "0" === m && ((v = "0" + v), J++, S++), 0 === S % E && K === T && 0 < F.length && (v = x + v);
        else
          ("E" !== m[0] && "e" !== m[0]) || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m)
            ? "," === m
              ? (K++, (E = S), (S = 0), 0 < F.length && (v = x + v))
              : (v = 1 < m.length && (('"' === m[0] && '"' === m[m.length - 1]) || ("'" === m[0] && "'" === m[m.length - 1])) ? m.slice(1, m.length - 1) + v : m + v)
            : ((m = 0 > P ? m.replace("+", "").replace("-", "") : m.replace("-", "")),
      ...
      for (M = !1; 0 < H.length; )
        (m = H.shift()),
          "#" === m || "0" === m
            ...
            ? (x += m.slice(1, m.length - 1))
            : ("E" !== m[0] && "e" !== m[0]) || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m)
            ? (x += m)
            : ((m = 0 > P ? m.replace("+", "").replace("-", "") : m.replace("-", "")),
              (x += m.replace(/[0]+/, function (a) {
                return X(P, a.length);
              })));
      v += (M ? w : "") + x;
      return r ? "-" + v : v;
    ...
    Oa = function (h) {
      var m = 0,
        v = 0;
      h = h || window.event;
      h.offsetX || 0 === h.offsetX ? ((m = h.offsetX), (v = h.offsetY)) : h.layerX || 0 == h.layerX ? ((m = h.layerX), (v = h.layerY)) : ((m = h.pageX - h.target.offsetLeft), (v = h.pageY - h.target.offsetTop));
      return { x: m, y: v };
    },
    ab = !0,
    ...
    V = function (h, m, v, r, w, x, F, E, N, M, Q, S, H) {
      ...
      h.globalAlpha = 1;
      0 < F && ((H = 0 === F % 2 ? 0 : 0.5), h.beginPath(), (h.lineWidth = F), (h.strokeStyle = E), h.moveTo(m, v), h.rect(m - H, v - H, r - m + 2 * H, w - v + 2 * H), h.stroke());
      h.restore();
      !0 === N &&
        (h.save(),
        h.beginPath(),
        ...
        h.lineTo(r, v),
        h.closePath(),
        (F = h.createLinearGradient((r + m) / 2, v + J, (r + m) / 2, v)),
        F.addColorStop(0, x),
      ...
      !0 === M &&
        ...
        h.lineTo(r, w),
        h.closePath(),
        (F = h.createLinearGradient((r + m) / 2, w - J, (r + m) / 2, w)),
        F.addColorStop(0, x),
        F.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = F),
        h.fill(),
      ...
      !0 === Q &&
        ...
        h.lineTo(m, w),
        h.closePath(),
        (F = h.createLinearGradient(m + J, (w + v) / 2, m, (w + v) / 2)),
        F.addColorStop(0, x),
      ...
      !0 === S &&
        ...
        h.lineTo(r - J, w - J),
        h.lineTo(r, w),
        (F = h.createLinearGradient(r - J, (w + v) / 2, r, (w + v) / 2)),
        F.addColorStop(0, x),
        F.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = F),
        F.addColorStop(0, x),
  ...
  (function () {
    ...
    S.pos = ["cm", "cs", "um"];
    S._fTWm = function (h) {
      if ("undefined" === typeof S.pro.sCH && !db)
        try {
  ...
  ba.prototype.set = function (h, m, r) {
    ...
    if ("options" === h) this.createUserOptions(m);
      ...
      window.console &&
        (w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readOnly" === w.publicProperties[h]
  ...
  ba.prototype.addTo = function (h, m, r, w) {
    ...
    x.hasOwnProperty(h) || (x.publicProperties && x.publicProperties.hasOwnProperty(h) && "readWrite" === x.publicProperties[h])
      ...
      : window.console &&
        (x.publicProperties && x.publicProperties.hasOwnProperty(h) && "readOnly" === x.publicProperties[h]
          ? window.console.log('Property "' + h + '" is read-only.')
          : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."));
  };
    ...
    if ("undefined" !== typeof h || this.options._isPlaceholder)
      if ((this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray)) {
        ...
        (this.options = "undefined" === typeof h ? {} : h),
          ...
          this.optionsName ? (m = this.optionsName) : (m = this._defaultsKey) && 0 !== m.length ? ((r = m.charAt(0).toLowerCase()), 1 < m.length && (r = r.concat(m.slice(1))), (m = r)) : (m = void 0),
          (h[m] = this.options);
  };
  ...
  ba.prototype.updateOption = function (h) {
    ...
    var m = oa[this._defaultsKey],
      ...
      J = this._index;
    this.theme && r(this.parent) && r(E) && r(J)
      ? (w = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[E] &&
        (null === J ? (w = this.parent.themeOptions[E]) : 0 < this.parent.themeOptions[E].length && ((w = Math.min(this.parent.themeOptions[E].length - 1, J)), (w = this.parent.themeOptions[E][w])));
    this.themeOptions = w;
  ...
  ba.prototype.trackChanges = function (h) {
    if (!this.sessionVariables) throw "Session Variable Store not set";
    this.sessionVariables[h] = this.options[h];
  };
  ba.prototype.isBeingTracked = function (h) {
    this.options._oldOptions || (this.options._oldOptions = {});
    return this.options._oldOptions[h] ? !0 : !1;
  };
  ba.prototype.hasOptionChanged = function (h) {
    if (!this.sessionVariables) throw "Session Variable Store not set";
    return this.sessionVariables[h] !== this.options[h];
  };
  ba.prototype.addEventListener = function (h, m, r) {
    h && m && ((this._eventListeners[h] = this._eventListeners[h] || []), this._eventListeners[h].push({ context: r || this, eventHandler: m }));
  };
  ba.prototype.removeEventListener = function (h, m) {
    if (h && m && this._eventListeners[h])
      for (var r = this._eventListeners[h], w = 0; w < r.length; w++)
        if (r[w].eventHandler === m) {
          r[w].splice(w, 1);
          break;
        }
  };
  ba.prototype.removeAllEventListeners = function () {
    this._eventListeners = [];
  };
  ba.prototype.dispatchEvent = function (h, m, r) {
    if (h && this._eventListeners[h]) {
      m = m || {};
      for (var w = this._eventListeners[h], x = 0; x < w.length; x++) w[x].eventHandler.call(w[x].context, m);
    }
  ...
  ia.prototype._initialize = function () {
    r(this.padding) || "object" !== typeof this.padding
      ...
      : ((this.topPadding = r(this.padding.top) ? 0 : Number(this.padding.top) | 0),
        (this.rightPadding = r(this.padding.right) ? 0 : Number(this.padding.right) | 0),
        (this.bottomPadding = r(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0),
        (this.leftPadding = r(this.padding.left) ? 0 : Number(this.padding.left) | 0));
  };
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - F * ("center" === this.horizontalAlign ? 2 : 1)), (J = 0.5 * m.height - this.margin - 2), (E = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = m.height - 4), (J = 0.5 * m.width - this.margin - 2))
            : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), (J = 0.5 * m.height - 4)));
      var M;
      ...
      M = J.measureText();
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign ? ((x = m.y1 + 2), (H = "top")) : "bottom" === this.verticalAlign && ((x = m.y2 - 2 - M.height), (H = "bottom")),
          "left" === this.horizontalAlign ? (w = m.x1 + 2) : "center" === this.horizontalAlign ? (w = m.x1 + m.width / 2 - M.width / 2) : "right" === this.horizontalAlign && (w = m.x2 - 2 - M.width - F),
          (N = this.horizontalAlign),
          (this.width = M.width),
          (this.height = M.height))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = m.x1 + 2), (x = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2)), (E = -90), (H = "left"), (this.width = M.height), (this.height = M.width))
            : "right" === this.horizontalAlign
            ? ((w = m.x2 - 2), (x = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2)), (E = 90), (H = "right"), (this.width = M.height), (this.height = M.width))
            : "center" === this.horizontalAlign && ((x = h.y1 + (h.height / 2 - M.height / 2)), (w = h.x1 + (h.width / 2 - M.width / 2)), (H = "center"), (this.width = M.width), (this.height = M.height)),
          (N = "center"));
      J.x = w;
      J.y = x;
      J.angle = E;
  ...
  Va.prototype.get = function (h, m) {
    var r = null;
    0 < this.pool.length ? ((r = this.pool.pop()), Ma(r, h, m)) : (r = sa(h, m));
    return r;
  };
  ...
  var Pa = {
    ...
    formatNumber: function (h, m, r) {
      r = r || "en";
      if (Ka[r]) return ea(h, m || "#,##0.##", new Ja(r));
      throw "Unknown Culture Name";
    },
    formatDate: function (h, m, r) {
      r = r || "en";
      if (Ka[r]) return Aa(h, m || "DD MMM YYYY", new Ja(r));
      throw "Unknown Culture Name";
    },
  };
  ...
  x = Pa.Chart = (function () {
    ...
    function m(a, d, c) {
      d = d || {};
      r(c)
        ? ((this.predefinedThemes = cb), (this.optionsName = this.parent = this.index = null))
        ...
        ? ((this.container.innerHTML = ""),
          ...
          this.canvas.getContext &&
            ...
            this.overlaidCanvas.getContext &&
              (this._canvasJSContainer.appendChild(this.overlaidCanvas), (this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d")), (this.overlaidCanvasCtx.textBaseline = "top"), Ca(this.overlaidCanvasCtx)),
            ...
            P(this._toolBar, { position: "absolute", right: "1px", top: "1px" }),
    ...
    function x(a, d, c, b, e, f, l, t, B, k) {
      ...
      B && 0 < t.thickness
        ...
        : 0 < t.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - p, e - l.thickness / 2));
      a.stroke();
    ...
    function F(a, d, c, b, e, f) {
      ...
      "axisX" === e
        ? ("left" === f || "bottom" === f
            ? ((this.optionsName = "axisX"), r(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisX[b]))
            : ((this.optionsName = "axisX2"), r(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisX2[b])),
          this.options.interval || (this.intervalType = null))
        : "left" === f || "bottom" === f
        ? ((this.optionsName = "axisY"), r(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisY[b]))
        : ((this.optionsName = "axisY2"), r(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}), (this.sessionVariables = this.chart.sessionVariables.axisY2[b]));
    ...
    function U(a, d, c, b) {
      ...
      if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
        for (a = 0; a < this.options.customBreaks.length; a++)
          this.customBreaks.push(new ca(this.chart, "customBreaks", this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)),
    ...
    m.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        if (this._zoomButton)
          P(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
          ...
          J(
            ...
            function () {
              d
                ? (d = !1)
                : (P(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
          ...
          J(
            ...
            function () {
              d ||
                (P(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                0 >= navigator.userAgent.search("MSIE") && P(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
            },
            this.allDOMEventHandlers
          );
        }
        this._resetButton
          ? (P(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
          ...
          : ((d = !1),
            ...
            J(
              ...
              function () {
                ...
                a.zoomEnabled || a.panEnabled
                  ? ((a.zoomEnabled = !0), (a.panEnabled = !1), ua(a, a._zoomButton, "pan"), (a._defaultCursor = "default"), (a.overlaidCanvas.style.cursor = a._defaultCursor))
            ...
            J(
              ...
              function () {
                d ||
                  (P(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                  0 >= navigator.userAgent.search("MSIE") && P(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
              },
              this.allDOMEventHandlers
            ),
            J(
              ...
              function () {
                d ||
                  (P(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                  0 >= navigator.userAgent.search("MSIE") && P(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
              },
              this.allDOMEventHandlers
            ),
        ...
        this.zoomEnabled ||
          this.panEnabled ||
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? ((this.panEnabled = !0), (this.zoomEnabled = !1)) : ((this.zoomEnabled = !0), (this.panEnabled = !1)), La(a._zoomButton, a._resetButton))
            : ((this.zoomEnabled = !0), (this.panEnabled = !1)));
      } else this.panEnabled = this.zoomEnabled = !1;
      ib(this);
      "none" !== this._toolBar.style.display &&
        this._zoomButton &&
        (this.panEnabled ? ua(a, a._zoomButton, "zoom") : ua(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && ua(a, a._resetButton, "reset"));
      ...
      if (this.options.data) {
        for (var c = 0; c < this.options.data.length; c++)
          if ((a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type))) {
            ...
            "error" === b.type &&
              ((b.linkedDataSeriesIndex = r(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex),
    ...
    m.prototype.setLayout = function () {
            ...
            if (this.options.axisY && 0 < this.options.axisY.length) {
              if (!this.axisY.length)
                for (var c = 0; c < this.options.axisY.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisY[c] = new F(this, "axisY", this.options.axisY[c], c, "axisY", "left")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[c] = new F(this, "axisY", this.options.axisY[c], c, "axisY", "bottom")));
              ...
              this.axisY.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisY[0] = new F(this, "axisY", this.options.axisY, 0, "axisY", "left")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[0] = new F(this, "axisY", this.options.axisY, 0, "axisY", "bottom")))),
            ...
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              if (!this.axisY2.length)
                for (c = 0; c < this.options.axisY2.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisY2[c] = new F(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY2[c] = new F(this, "axisY2", this.options.axisY2[c], c, "axisY", "top")));
              ...
              this.axisY2.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisY2[0] = new F(this, "axisY2", this.options.axisY2, 0, "axisY", "right")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY2[0] = new F(this, "axisY2", this.options.axisY2, 0, "axisY", "top")))),
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              if (!this.axisX.length)
                for (c = 0; c < this.options.axisX.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisX[c] = new F(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[c] = new F(this, "axisX", this.options.axisX[c], c, "axisX", "left")));
              ...
              this.axisX.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisX[0] = new F(this, "axisX", this.options.axisX, 0, "axisX", "bottom")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[0] = new F(this, "axisX", this.options.axisX, 0, "axisX", "left")))),
            ...
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              if (!this.axisX2.length)
                for (c = 0; c < this.options.axisX2.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisX2[c] = new F(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[c] = new F(this, "axisX2", this.options.axisX2[c], c, "axisX", "right")));
              ...
              this.axisX2.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisX2[0] = new F(this, "axisX2", this.options.axisX2, 0, "axisX", "top")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[0] = new F(this, "axisX2", this.options.axisX2, 0, "axisX", "right")))),
      ...
      for (d = 0; d < this._axes.length; d++)
        if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
          w ? ((this._breaksCanvas = sa(this.width, this.height, !0)), (this._breaksCanvasCtx = this._breaksCanvas.getContext("2d"))) : ((this._breaksCanvas = this.canvas), (this._breaksCanvasCtx = this.ctx));
          break;
        }
    ...
    m.prototype.renderElements = function () {
      ...
      Ha &&
        ...
        setTimeout(function () {
          ...
          a && (Ma(a, n.width, n.height), a.getContext("2d").drawImage(n._eventManager.ghostCanvas, 0, 0));
        }, 2e3));
    ...
    m.prototype._processData = function () {
      ...
      for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
        for (var d = this.plotInfo.plotTypes[a], c = 0; c < d.plotUnits.length; c++) {
          var b = d.plotUnits[c];
          "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type
          ...
          for (B = 0; B < t.dataPoints.length; B++) {
            ...
            if (0 < B) {
              if (a.axisX.logarithmic) {
                var s = b / t.dataPoints[B - 1].x;
                1 > s && (s = 1 / s);
                c.minDiff > s && 1 !== s && (c.minDiff = s);
              } else (s = b - t.dataPoints[B - 1].x), 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s);
              null !== e &&
                null !== t.dataPoints[B - 1].y &&
                (a.axisY.logarithmic
                  ? ((s = e / t.dataPoints[B - 1].y), 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s))
                  : ((s = e - t.dataPoints[B - 1].y), 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s)));
            }
            if (b < q && !k) null !== e && (p = b);
            else {
              if (!k && ((k = !0), 0 < B)) {
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], B = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var Qa = a.axisX.sessionVariables.newViewportMinimum
                ? a.axisX.sessionVariables.newViewportMinimum
                : this.options.axisX && this.options.axisX.viewportMinimum
                ? this.options.axisX.viewportMinimum
                : this.options.axisX && this.options.axisX.minimum
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (0 < q) {
              ...
              } else (m = b - p.dataPoints[q - 1].x), 0 > m && (m *= -1), c.minDiff > m && 0 !== m && (c.minDiff = m);
              null !== e &&
                null !== p.dataPoints[q - 1].y &&
                (a.axisY.logarithmic
                  ? 0 < e && ((m = e / p.dataPoints[q - 1].y), 1 > m && (m = 1 / m), d.minDiff > m && 1 !== m && (d.minDiff = m))
                  : ((m = e - p.dataPoints[q - 1].y), 0 > m && (m *= -1), d.minDiff > m && 0 !== m && (d.minDiff = m)));
            }
            if (b < Qa && !g) null !== p.dataPoints[q].y && (h = b);
            else {
              if (!g && ((g = !0), 0 < q)) {
                q -= 2;
                continue;
              ...
              null === p.dataPoints[q].y
                ...
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  ...
                  0 <= e ? (l[b] ? (l[b] += e) : ((l[b] = e), (B = Math.min(e, B)))) : t[b] ? (t[b] += e) : ((t[b] = e), (k = Math.max(e, k))));
            }
          }
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t))
              : ((d.dataPointYPositiveSums = l), (d.dataPointYNegativeSums = t)));
          p.axisX.valueType = p.xValueType = f ? "dateTime" : "number";
        }
        for (q in l)
          l.hasOwnProperty(q) &&
            !isNaN(q) &&
            ((a = l[q]), a < d.min && (d.min = Math.min(a, B)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
        for (q in t)
          t.hasOwnProperty(q) &&
            !isNaN(q) &&
            ((a = t[q]), a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))));
      }
    };
          ...
          for (p = 0; p < n.dataPoints.length; p++) {
            ...
            if (0 < p) {
              ...
              r(e) ||
                ...
                (a.axisY.logarithmic
                  ? 0 < e && ((u = e / n.dataPoints[p - 1].y), 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u))
                  : ((u = e - n.dataPoints[p - 1].y), 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)));
            }
            if (b < h && !q) null !== e && (s = b);
            else {
              if (!q && ((q = !0), 0 < p)) {
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
                ? c.viewPortMin === b && s < b && (c.viewPortMin = s)
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e), (a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e)), 0 <= e ? (l = !0) : 0 > e && (t = !0), (B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e)));
            }
          }
          n.axisX.valueType = n.xValueType = f ? "dateTime" : "number";
        }
        a.axisY.logarithmic
          ? ((d.max = r(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05))), (d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
          : l && !t
          ? ((d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)), (d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
          : l && t
          ? ((d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)), (d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)))
          : !l && t && ((d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
        d.viewPortMin = d.min;
        d.viewPortMax = d.max;
        a.dataPointYSums = B;
      }
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          for (n = 0; n < k.dataPoints.length; n++) {
            ...
            k.dataPoints[n].x.getTime ? ((t = !0), (b = k.dataPoints[n].x.getTime())) : (b = k.dataPoints[n].x);
            if ((e = k.dataPoints[n].y) && e.length) {
              f = Math.min.apply(null, e);
              l = Math.max.apply(null, e);
              s = !0;
              for (var z = 0; z < e.length; z++) null === e.k && (s = !1);
              s && (p || (h = g), (g = b));
            }
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            l > d.max && (d.max = l);
            0 < n &&
              (a.axisX.logarithmic ? ((s = b / k.dataPoints[n - 1].x), 1 > s && (s = 1 / s), c.minDiff > s && 1 !== s && (c.minDiff = s)) : ((s = b - k.dataPoints[n - 1].x), 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s)),
              e &&
                null !== e[0] &&
                k.dataPoints[n - 1].y &&
                null !== k.dataPoints[n - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((s = e[0] / k.dataPoints[n - 1].y[0]), 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s))
                  : ((s = e[0] - k.dataPoints[n - 1].y[0]), 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s))));
            if (!(b < m) || p) {
              if (!p && ((p = !0), 0 < n)) {
                n -= 2;
                g = h;
        ...
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          for (B = 0; B < t.dataPoints.length; B++)
            if (
              ...
              0 < B &&
                (a.axisX.logarithmic
                  ? ((p = b / t.dataPoints[B - 1].x), 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p))
                  : ((p = b - t.dataPoints[B - 1].x), 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)),
                null !== e &&
                  null !== t.dataPoints[B - 1].y &&
                  (a.axisY.logarithmic
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < B &&
                (t.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[B - 1].cumulativeSum), t.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[B - 1].cumulativeSum));
                ...
                for (t = 0; t < h.dataPoints.length; t++)
                  if (
                    (b &&
                      ...
                      (g = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x),
                      (q = Math.floor((g - k) / q)),
                      g < f[q].min && (f[q].min = g),
                      g > f[q].max && (f[q].max = g)),
                    c)
        ...
        for (l = 0; l < this._axes.length; l++)
          if (this._axes[l].dataInfo._dataRanges) {
              ...
              if (((n = k[t].max), isFinite(n)))
                for (; t < k.length - 1; )
                  if (((B = k[t + 1].min), isFinite(B))) {
                    p = B - n;
                    p > b && f.push({ diff: p, start: n, end: B });
                    break;
                  } else t++;
            if (this._axes[l].scaleBreaks.customBreaks)
              for (t = 0; t < this._axes[l].scaleBreaks.customBreaks.length; t++)
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue) ||
                    (this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue) ||
                    (f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].startValue && this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].end) ||
                    (f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue && this._axes[l].scaleBreaks.customBreaks[t].endValue <= f[b].end)
                  )
                    f.splice(b, 1), b--;
            f.sort(function (a, b) {
            ...
            for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++)
              (b = a(f[t].start, f[t].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                this._axes[l].scaleBreaks.autoBreaks.push(new ca(this, "autoBreaks", b, t, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
          ...
          if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), (this.isDrag = !1);
            ...
            for (c = 0; c < d.length; c++)
              if (
                ...
                (!r(this._lastTouchData.scroll) && !this._lastTouchData.scroll) || (!this._lastTouchData.scroll && 250 < f) || "click" === e)
              )
    ...
    m.prototype._mouseEventHandler = function (a) {
      ...
      m.capturedEventParam &&
        ...
        b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? (a.target !== b.chart.overlaidCanvas && w) || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
      if (this.interactivityEnabled)
        if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
        else if (
          (a.preventManipulation && a.preventManipulation(),
          a.preventDefault && a.preventDefault(),
          Ha && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")),
          !e)
        ) {
      ...
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
        ...
        if (this.panEnabled || this.zoomEnabled) {
              ...
              (c = this._axes[e]),
                c.logarithmic
                  ? c.viewportMinimum < c.minimum
                    ...
                    : c.viewportMaximum > c.maximum && ((f = c.viewportMaximum / c.maximum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum / f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum / f), (l = !0))
                  : c.viewportMinimum < c.minimum
                  ? ((f = c.minimum - c.viewportMinimum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum + f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum + f), (l = !0))
                  : c.viewportMaximum > c.maximum && ((f = c.viewportMaximum - c.maximum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum - f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum - f), (l = !0));
          ...
          l &&
            ...
            l && this.zoomEnabled && "none" === this._zoomButton.style.display && (La(this._zoomButton, this._resetButton), ua(this, this._zoomButton, "pan"), ua(this, this._resetButton, "reset")));
        }
      }
      this.isDrag = !1;
      ...
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
          if (this.panEnabled)
            ...
            this.validateRegion(b, t, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid &&
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      e = e || !1;
      for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], n = [], p = 0; p < this._axes.length; p++)
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (q > g)
          var s = g,
            g = q,
            q = s;
        if (p.scaleBreaks) for (s = 0; !f && s < p.scaleBreaks._appliedBreaks.length; s++) f = p.scaleBreaks._appliedBreaks[s].startValue <= q && p.scaleBreaks._appliedBreaks[s].endValue >= g;
        if (isFinite(p.dataInfo.minDiff))
          if (
            ((s = p.getApparentDifference(q, g, null, !0)),
            !(
              f ||
              (!(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && ((p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3)) || (!p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)))) ||
              q < p.minimum ||
              g > p.maximum
            ))
          )
            B.push(p), n.push({ val1: q, val2: g }), (t = !0);
          else if (!e) {
            t = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var m = ka("indexLabelLineDashType", n.dataPoint, n.dataSeries),
          ...
          C = null;
        if (0 <= n.dataSeries.type.indexOf("stacked") || "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) y = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
        ...
        var D = n.dataPoint.indexLabelFormatter
          ? n.dataPoint.indexLabelFormatter(C)
          ...
          ? n.dataSeries.indexLabelFormatter(C)
        ...
        if (null !== D && "" !== D) {
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== y
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g = n.point.y + ("horizontal" === C ? s / 2 : 0) - k - t - b), g < e && ((g = "auto" === y ? Math.max(n.point.y, e) + s / 2 + t : e + s / 2 + t), (x = g + k > n.point.y)))
                  : ((g = n.point.y + s / 2 + t + b), g > f - k && ((g = "auto" === y ? Math.min(n.point.y, f) + s / 2 - k - t : f + s / 2 - k), (x = g < n.point.y))))
              : ((e = Math.max(n.bounds.y1, c.y1)),
                (f = Math.min(n.bounds.y2, c.y2 - k + s / 2)),
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < v
                      ? Math.max(n.bounds.y1, c.y1) + s / 2 + t
                      : Math.min(n.bounds.y2, c.y2) + s / 2 - k + t
                    : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + s / 2 + ("horizontal" === C ? t : 0)),
                0 < v
                  ? ((g = Math.max(n.point.y, b)), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(n.point.y - k - t, c.y1 + t)))
                  : ((g = Math.min(n.point.y, b)), g > f - k - t && ("bubble" === p || "scatter" === p) && (g = Math.min(n.point.y + t, c.y2 - k - t))),
                (g = Math.min(g, f)));
          } else
            0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((y = "auto"), (l = 4)) : 0 <= p.indexOf("stacked") ? "auto" === y && (y = "inside") : "bubble" === p && (y = "inside"),
              (g = n.point.y + s / 2 - k / 2 + t),
              "inside" !== y
                ? ((e = c.x1),
                  (f = c.x2),
                  0 > v
                    ? ((q = n.point.x - ("horizontal" === C ? B : B - s / 2) - l - b), q < e && ((q = "auto" === y ? Math.max(n.point.x, e) + l : e + l), (x = q + B > n.point.x)))
                    : ((q = n.point.x + ("horizontal" === C ? 0 : s / 2) + l + b), q > f - B - l - b && ((q = "auto" === y ? Math.min(n.point.x, f) - ("horizontal" === C ? B : B / 2) - l : f - B - l), (x = q < n.point.x))))
                : ((e = Math.max(n.bounds.x1, c.x1)),
                  Math.min(n.bounds.x2, c.x2),
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > v
                        ? Math.max(n.bounds.x1, c.x1) + s / 2 + l
                        : Math.min(n.bounds.x2, c.x2) - B / 2 - l + ("horizontal" === C ? 0 : s / 2)
                      : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === C ? 0 : s / 2)),
                  (q = 0 > v ? Math.max(n.point.x, b) - ("horizontal" === C ? B / 2 : 0) : Math.min(n.point.x, b) - B / 2),
                  (q = Math.max(q, e)));
          "vertical" === C && (g += k - s / 2);
          h.x = q;
          h.y = g;
          ...
          z &&
            "inside" !== y &&
            ((0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2) || !x) &&
            ((0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 && n.point.y < c.y2) || !x) &&
            ((d.lineWidth = z),
            (d.strokeStyle = u ? u : "gray"),
            d.setLineDash && d.setLineDash(N(m, z)),
            d.beginPath(),
            d.moveTo(n.point.x, n.point.y),
            0 <= p.indexOf("bar") || ("error" === p && n.axisSwapped)
              ? d.lineTo(q + (0 < n.direction ? -l : B + l) + ("vertical" === C ? -s / 2 : 0), g + ("vertical" === C ? -k / 2 : k / 2 - s / 2) - t)
              : 0 <= p.indexOf("column") || ("error" === p && !n.axisSwapped)
              ? d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : s / 2), g + ("vertical" === C ? (g - k < n.point.y ? 0 : -k) + t : (g - s / 2 < n.point.y ? k : 0) - s / 2))
              : d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : s / 2), g + ("vertical" === C ? (g - k < n.point.y ? 0 : -k) : (g - s / 2 < n.point.y ? k : 0) - s / 2)),
            d.stroke());
        }
      }
                  ...
                  m || C
                    ? (!m && k.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(z, r),
                          w && b.lineTo(z, r))
                        : (c.beginPath(), c.moveTo(z, r), w && (b.beginPath(), b.moveTo(z, r))),
                      (C = m = !1))
                    : (c.lineTo(z, r), w && b.lineTo(z, r), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(z, r), w && (b.stroke(), b.beginPath(), b.moveTo(z, r))));
                  l = { x: z, y: r };
                  u < n.length - 1 &&
                    (h !== (n[u].lineColor || s) || p !== (n[u].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(z, r),
                    (h = n[u].lineColor || s),
                    (c.strokeStyle = h),
                    c.setLineDash && (n[u].lineDashType ? ((p = n[u].lineDashType), c.setLineDash(N(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[u].markerSize || 0 < k.markerSize) {
                    var A = k.getMarkerProperties(u, z, r, c);
                    f.push(A);
                    D = Q(D);
                    w && f.push({ x: z, y: r, ctx: b, type: A.type, size: A.size, color: D, borderColor: D, borderThickness: A.borderThickness });
                  }
                  (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "line", dataPoint: n[u], dataSeries: k, point: { x: z, y: r }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: s });
                }
            c.stroke();
            w && b.stroke();
          }
                  ...
                  m || C
                    ? (!m && k.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(r, D),
                          c.lineTo(r, y),
                          w && (b.lineTo(r, D), b.lineTo(r, y)))
                        : (c.beginPath(), c.moveTo(r, y), w && (b.beginPath(), b.moveTo(r, y))),
                      (C = m = !1))
                    : (c.lineTo(r, D), w && b.lineTo(r, D), c.lineTo(r, y), w && b.lineTo(r, y), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, y), w && (b.stroke(), b.beginPath(), b.moveTo(r, y))));
                  l = { x: r, y: y };
                  u < n.length - 1 &&
                    (h !== (n[u].lineColor || s) || p !== (n[u].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    ...
                    c.setLineDash && (n[u].lineDashType ? ((p = n[u].lineDashType), c.setLineDash(N(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, r, y, c)), f.push(D), (A = Q(A)), w && f.push({ x: r, y: y, ctx: b, type: D.type, size: D.size, color: A, borderColor: A, borderThickness: D.borderThickness });
                  (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stepLine", dataPoint: n[u], dataSeries: k, point: { x: r, y: y }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: s });
                }
            c.stroke();
            w && b.stroke();
          }
        ...
        if (0 < a.length) {
          ...
          for (var c = 0; c < a.length - 3; c += 3)
            if (
              ...
              w && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
              ...
              b.stroke(),
                ...
                w && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
          b.stroke();
          w && e.stroke();
        }
      }
            ...
            for (r = !1, m = 0; m < n.length; m++)
              if (((u = n[m].getTime ? n[m].x.getTime() : n[m].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !r)))))
                if ("number" !== typeof n[m].y)
                  0 < m && !r && (k.connectNullData ? b.setLineDash && 0 < y.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType) && ((y[y.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType)) : (d(y), (y = []))),
                    (r = !0);
                else {
                  ...
                  y[y.length] = { x: u, y: r };
                  m < n.length - 1 &&
                    (h !== (n[m].lineColor || s) || p !== (n[m].lineDashType || k.lineDashType)) &&
                    ((h = n[m].lineColor || s),
                    (y[y.length - 1].newStrokeStyle = h),
                    b.setLineDash && (n[m].lineDashType ? ((p = n[m].lineDashType), (y[y.length - 1].newLineDashArray = N(p, k.lineThickness))) : ((p = k.lineDashType), (y[y.length - 1].newLineDashArray = g))));
                  if (0 < n[m].markerSize || 0 < k.markerSize) {
                    var D = k.getMarkerProperties(m, u, r, b);
                    l.push(D);
                    C = Q(C);
                    w && l.push({ x: u, y: r, ctx: e, type: D.type, size: D.size, color: C, borderColor: C, borderThickness: D.borderThickness });
                  }
                  (n[m].indexLabel || k.indexLabel || n[m].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "spline", dataPoint: n[m], dataSeries: k, point: { x: u, y: r }, direction: 0 > n[m].y === a.axisY.reversed ? 1 : -1, color: s });
                  r = !1;
                }
          d(y);
        }
          ...
          if (0 < s.length)
            for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
              if ((s[f].getTime ? (B = s[f].x.getTime()) : (B = s[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y)) {
                ...
                V(c, a.axisX.reversed ? m : l, t, a.axisX.reversed ? l : m, u, b, 0, null, h && (a.axisY.reversed ? 0 > s[f].y : 0 <= s[f].y), (a.axisY.reversed ? 0 <= s[f].y : 0 > s[f].y) && h, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                ...
                (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) &&
            ...
            for (k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                  (t[b] = u[k].y + (t[b] ? t[b] : 0)), 0 < t[b] && ((p = a.axisY.convertValueToPixel(t[b])), (D = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = p));
                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)), (D = a.axisY.convertValueToPixel(B[b])), (p = "undefined" !== typeof l[b] ? l[b] : q), (l[b] = D);
                ...
                (u[k].indexLabel || m.indexLabel || u[k].indexLabelFormatter || m.indexLabelFormatter) &&
                  this._indexLabels.push({
                    ...
                    bounds: { x1: y, y1: Math.min(p, D), x2: C, y2: Math.max(p, D) },
                    color: b,
                  });
              }
          }
            ...
            for (var r = 5 < g && m.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                  ...
                  (B[b] = p + ("undefined" !== typeof B[b] ? B[b] : 0)), (D = a.axisY.convertValueToPixel(B[b])), (p = l[b] ? l[b] : q), (l[b] = D);
                  ...
                  f[b] = A + (D - p);
                } else (A = "undefined" !== typeof l[b] ? l[b] : 0), (D = p + A), (p = q + A), a.dataSeriesIndexes.length - 1 === s && 1 >= Math.abs(e.y2 - D) && (D = e.y2), (l[b] = A + (D - p));
                b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
                V(c, y, a.axisY.reversed ? D : p, C, a.axisY.reversed ? p : D, b, 0, null, r && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && r, !1, !1, m.fillOpacity);
                b = m.dataPointIds[k];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: y, y1: p, x2: C, y2: D };
          ...
          if (0 < s.length) {
            ...
            for (f = 0; f < s.length; f++)
              if ((s[f].getTime ? (B = s[f].x.getTime()) : (B = s[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y)) {
                ...
                t = a.axisX.reversed ? (t + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + n) * p) << 0 : (t - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + n) * p) << 0;
                ...
                (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) &&
                  this._indexLabels.push({
                    ...
                    dataPoint: s[f],
                    dataSeries: g,
                    point: { x: 0 <= s[f].y ? l : u, y: t + (m - t) / 2 },
                    direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(u, l), y1: t, x2: Math.max(u, l), y2: m },
                    color: b,
                  });
              }
          }
            ...
            for (k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                ...
                var y = (p - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                  ...
                  D;
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                  (t[b] = u[k].y + (t[b] ? t[b] : 0)), 0 < t[b] && ((D = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(t[b])));
                  ...
                  n += A;
                  f[b] = A + (n - D);
                } else (A = l[b] ? l[b] : 0), (D = n - A), (n = q - A), (l[b] = A + (n - D));
                b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
                ...
                (u[k].indexLabel || m.indexLabel || u[k].indexLabelFormatter || m.indexLabelFormatter) &&
                  this._indexLabels.push({
                    ...
                    dataPoint: u[k],
                    dataSeries: m,
                    point: { x: 0 <= u[k].y ? n : D, y: p },
                    direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(D, n), y1: y, x2: Math.max(D, n), y2: C },
                    color: b,
                  });
              }
          }
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                p = a.axisX.convertValueToPixel(b);
                var y;
                y = 0 !== a.dataPointYSums[b] ? 100 * (u[k].y / a.dataPointYSums[b]) : 0;
                ...
                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (B[b] = y + (B[b] ? B[b] : 0)), (n = l[b] ? l[b] : q), (l[b] = y = a.axisY.convertValueToPixel(B[b]));
                ...
                b = Q(b);
                w && V(this._eventManager.ghostCtx, y, C, n, D, b, 0, null, !1, !1, !1, !1);
                (u[k].indexLabel || m.indexLabel || u[k].indexLabelFormatter || m.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "stackedBar100",
                    dataPoint: u[k],
                    dataSeries: m,
                    point: { x: 0 <= u[k].y ? n : y, y: p },
                    direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(y, n), y1: C, x2: Math.max(y, n), y2: D },
                    color: b,
                  });
              }
          }
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        D &&
          ...
          a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (C = y) : 0 > a.axisY.viewportMaximum ? (C = t.y1) : 0 < a.axisY.viewportMinimum && (C = y),
          f.lineTo(m, C),
          f.lineTo(D.x, C),
          f.closePath(),
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(m, C), l.lineTo(D.x, C), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(m, u),
          l.beginPath(),
          l.moveTo(m, u),
          ...
          if (0 < s.length) {
            ...
            for (var ja = !0; h < s.length; h++)
              if (((r = s[h].x.getTime ? s[h].x.getTime() : s[h].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))))
                if ("number" !== typeof s[h].y) g.connectNullData || ja || d || b(), (ja = !0);
                else {
                  ...
                  d || ja
                    ? (!d && g.connectNullData
                        ? (f.setLineDash &&
                            ...
                            ((d = m), (c = u), (m = n.x), (u = n.y), b(), f.moveTo(n.x, n.y), (m = d), (u = c), (D = n), (c = g.nullDataLineDashType), f.setLineDash(R)),
                          f.lineTo(m, u),
                          w && l.lineTo(m, u))
                        : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), (D = { x: m, y: u })),
                      (ja = d = !1))
                    : (f.lineTo(m, u), w && l.lineTo(m, u), 0 == h % 250 && b());
                  n = { x: m, y: u };
                  h < s.length - 1 &&
                    (x !== (s[h].lineColor || v) || c !== (s[h].lineDashType || g.lineDashType)) &&
                    (b(), (x = s[h].lineColor || v), (f.strokeStyle = x), f.setLineDash && (s[h].lineDashType ? ((c = s[h].lineDashType), f.setLineDash(N(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(aa))));
                  ...
                  0 !== s[h].markerSize &&
                    (0 < s[h].markerSize || 0 < g.markerSize) &&
                    ((r = g.getMarkerProperties(h, m, u, f)), B.push(r), (Y = Q(Y)), w && B.push({ x: m, y: u, ctx: l, type: r.type, size: r.size, color: Y, borderColor: Y, borderThickness: r.borderThickness }));
                  (s[h].indexLabel || g.indexLabel || s[h].indexLabelFormatter || g.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "area", dataPoint: s[h], dataSeries: g, point: { x: m, y: u }, direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1, color: A });
                }
            b();
            $.drawMarkers(B);
          }
          ...
          if (0 < n.lineThickness) {
            ...
            for (var d = 0; d < c.length - 3; d += 3)
              if (
                ...
                w && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y),
            ...
            for (s = !1; q < p.length; q++)
              if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !s)))))
                if ("number" !== typeof p[q].y)
                  0 < q && !s && (n.connectNullData ? b.setLineDash && 0 < r.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = x), (A = n.nullDataLineDashType)) : (d(), (r = []))),
                    (s = !0);
                else {
                  ...
                  r[r.length] = { x: g, y: s };
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || C) || A !== (p[q].lineDashType || n.lineDashType)) &&
                    ((D = p[q].lineColor || C),
                    (r[r.length - 1].newStrokeStyle = D),
                    b.setLineDash && (p[q].lineDashType ? ((A = p[q].lineDashType), (r[r.length - 1].newLineDashArray = N(A, n.lineThickness))) : ((A = n.lineDashType), (r[r.length - 1].newLineDashArray = F))));
                  if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) {
                    var aa = n.getMarkerProperties(q, g, s, b);
                    l.push(aa);
                    R = Q(R);
                  ...
                  (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: { x: g, y: s }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: y });
                  s = !1;
                }
            d();
            $.drawMarkers(l);
                ...
                "number" !== typeof s[h].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(r)),
                    ...
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              (g.options.nullDataLineDashType || (R === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
                              ((d = m), (c = u), (m = n.x), (u = n.y), b(), f.moveTo(n.x, n.y), (m = d), (u = c), (D = n), (R = g.nullDataLineDashType), f.setLineDash(aa)),
                            f.lineTo(m, Y),
                            f.lineTo(m, u),
                            w && (l.lineTo(m, Y), l.lineTo(m, u)))
                          : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), (D = { x: m, y: u })),
                        (c = d = !1))
                      : (f.lineTo(m, Y), w && l.lineTo(m, Y), f.lineTo(m, u), w && l.lineTo(m, u), 0 == h % 250 && b()),
                    (n = { x: m, y: u }),
                    h < s.length - 1 &&
                      (x !== (s[h].lineColor || v) || R !== (s[h].lineDashType || g.lineDashType)) &&
                      (b(), (x = s[h].lineColor || v), (f.strokeStyle = x), f.setLineDash && (s[h].lineDashType ? ((R = s[h].lineDashType), f.setLineDash(N(R, g.lineThickness))) : ((R = g.lineDashType), f.setLineDash(F)))),
                    (r = g.dataPointIds[h]),
                    (this._eventManager.objectMap[r] = { id: r, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: m, y1: u }),
                    0 !== s[h].markerSize &&
                      (0 < s[h].markerSize || 0 < g.markerSize) &&
                      ((Y = g.getMarkerProperties(h, m, u, f)), B.push(Y), (r = Q(r)), w && B.push({ x: m, y: u, ctx: l, type: Y.type, size: Y.size, color: r, borderColor: r, borderThickness: Y.borderThickness })),
                    (s[h].indexLabel || g.indexLabel || s[h].indexLabelFormatter || g.indexLabelFormatter) &&
                      this._indexLabels.push({ chartType: "stepArea", dataPoint: s[h], dataSeries: g, point: { x: m, y: u }, direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1, color: A }));
              }
            b();
            $.drawMarkers(B);
          }
            ...
            for (var Y = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))))
                if ("number" !== typeof fa.y) A.connectNullData || Y || z || d(), (Y = !0);
                  ...
                  } else (s = a.axisY.convertValueToPixel(fa.y)), (s -= la);
                  k.push({ x: g, y: m - la });
                  h[f] = m - s;
                  z || Y
                    ? (!z && A.connectNullData
                        ? (b.setLineDash &&
                            (A.options.nullDataLineDashType || (y === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((z = k.pop()), (y = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(y), k.push(z), (y = A.nullDataLineDashType), b.setLineDash(aa)),
                          b.lineTo(g, s),
                          w && r.lineTo(g, s))
                        : (b.beginPath(), b.moveTo(g, s), w && (r.beginPath(), r.moveTo(g, s))),
                      (Y = z = !1))
                    : (b.lineTo(g, s), w && r.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && r.moveTo(g, s), k.push({ x: g, y: m - la })));
                  u = { x: g, y: s };
                  q < v.length - 1 &&
                    (R !== (v[q].lineColor || x) || y !== (v[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, s),
                    k.push({ x: g, y: m - la }),
                    (R = v[q].lineColor || x),
                    (b.strokeStyle = R),
                    b.setLineDash && (v[q].lineDashType ? ((y = v[q].lineDashType), b.setLineDash(N(y, A.lineThickness))) : ((y = A.lineDashType), b.setLineDash(F))));
                  if (0 <= A.dataPointIndexes[f]) {
                    var E = A.dataPointIds[A.dataPointIndexes[f]];
                    this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: A.dataPointIndexes[f], x1: g, y1: s };
                  }
                  0 <= A.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < A.markerSize) &&
                    ((la = A.getMarkerProperties(A.dataPointIndexes[f], g, s, b)), l.push(la), (f = Q(E)), w && l.push({ x: g, y: s, ctx: r, type: la.type, size: la.size, color: f, borderColor: f, borderThickness: la.borderThickness }));
                  (fa.indexLabel || A.indexLabel || fa.indexLabelFormatter || A.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: A, point: { x: g, y: s }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                }
            }
            d();
            b.moveTo(g, s);
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))))
                if ("number" !== typeof fa.y) A.connectNullData || Y || r || d(), (Y = !0);
                  ...
                  r || Y
                    ? (!r && A.connectNullData
                        ? (b.setLineDash &&
                            (A.options.nullDataLineDashType || (u === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((r = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(m.x, m.y), k.push(u), k.push(r), (u = A.nullDataLineDashType), b.setLineDash(aa)),
                          b.lineTo(g, s),
                          w && y.lineTo(g, s))
                        : (b.beginPath(), b.moveTo(g, s), w && (y.beginPath(), y.moveTo(g, s))),
                      (Y = r = !1))
                    : (b.lineTo(g, s), w && y.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && y.moveTo(g, s), k.push({ x: g, y: z - E })));
                  m = { x: g, y: s };
                  q < v.length - 1 &&
                    (R !== (v[q].lineColor || x) || u !== (v[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, s),
                    k.push({ x: g, y: z - E }),
                    (R = v[q].lineColor || x),
                    (b.strokeStyle = R),
                    b.setLineDash && (v[q].lineDashType ? ((u = v[q].lineDashType), b.setLineDash(N(u, A.lineThickness))) : ((u = A.lineDashType), b.setLineDash(F))));
                  if (0 <= A.dataPointIndexes[f]) {
                  ...
                  0 <= A.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < A.markerSize) &&
                    ((E = A.getMarkerProperties(q, g, s, b)), t.push(E), (f = Q(G)), w && t.push({ x: g, y: s, ctx: y, type: E.type, size: E.size, color: f, borderColor: f, borderThickness: E.borderThickness }));
                  (fa.indexLabel || A.indexLabel || fa.indexLabelFormatter || A.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: A, point: { x: g, y: s }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                }
            }
            d();
            b.moveTo(g, s);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
          for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++)
            (f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || ((g = q[e].z), g > t && (t = g), g < h && (h = g));
        for (var s = 25 * Math.PI, m = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, s), k = 0; k < a.dataSeriesIndexes.length; k++)
            ...
            for (var p = 0, q = 0, e = 0; e < n.length; e++)
              if (((f = n[e].getTime ? (f = n[e].x.getTime()) : (f = n[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y)) {
                ...
                (Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                  ...
                  (p = Q(p)),
                  w && $.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < z.length)
            for (var y = 5 < s && u.bevelEnabled ? !0 : !1, t = 0; t < z.length; t++)
              if (
                (z[t].getTime ? (g = z[t].x.getTime()) : (g = z[t].x),
                !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                  !r(z[t].y) &&
                  z[t].y.length &&
                  "number" === typeof z[t].y[0] &&
                  "number" === typeof z[t].y[1] &&
                  "number" === typeof z[t].y[2] &&
                  "number" === typeof z[t].y[3])
              ) {
                ...
                "candlestick" === u.type
                  ? (c.moveTo(h - x, n),
                    ...
                    c.lineTo(h - x, p),
                    c.stroke(),
                    V(c, C, Math.min(k, q), v, Math.max(k, q), z[t].y[0] <= z[t].y[3] ? u.risingColor : f, A, e, y, y, !1, !1, u.fillOpacity),
                    w &&
                      ((e = Q(F)),
                      (b.strokeStyle = e),
                      b.moveTo(h - x, n),
                      ...
                      b.lineTo(h - x, p),
                      b.stroke(),
                      V(b, C, Math.min(k, q), v, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                  : "ohlc" === u.type &&
                    (c.moveTo(h - x, n),
                    c.lineTo(h - x, p),
                    c.stroke(),
                ...
                (z[t].indexLabel || u.indexLabel || z[t].indexLabelFormatter || u.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: u.type,
                    dataPoint: z[t],
                    dataSeries: u,
                    point: { x: C + (v - C) / 2, y: a.axisY.reversed ? p : n },
                    direction: 1,
                    bounds: { x1: C, y1: Math.min(n, p), x2: v, y2: Math.max(n, p) },
                    color: e,
                  });
              }
        }
        ...
        for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < y.length)
            for (var C = 5 < s && z.bevelEnabled ? !0 : !1, l = 0; l < y.length; l++)
              if (
                (y[l].getTime ? (g = y[l].x.getTime()) : (g = y[l].x),
                !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                  !r(y[l].y) &&
                  y[l].y.length &&
                  "number" === typeof y[l].y[0] &&
                  "number" === typeof y[l].y[1] &&
                  "number" === typeof y[l].y[2] &&
                  "number" === typeof y[l].y[3] &&
                  "number" === typeof y[l].y[4] &&
                  5 === y[l].y.length)
              ) {
                ...
                var D = (t - s / 2) << 0,
                  ...
                  F = 0 === x % 2 ? 0 : 0.5,
                  R = y[l].whiskerColor ? y[l].whiskerColor : y[l].color ? (z.whiskerColor ? z.whiskerColor : y[l].color) : z.whiskerColor ? z.whiskerColor : e,
                  ...
                  la = y[l].stemColor ? y[l].stemColor : y[l].color ? (z.stemColor ? z.stemColor : y[l].color) : z.stemColor ? z.stemColor : e,
                ...
                c.save();
                0 < Ba && (c.beginPath(), (c.strokeStyle = la), (c.lineWidth = Ba), c.setLineDash && c.setLineDash(N(J, Ba)), c.moveTo(t - G, k), c.lineTo(t - G, h), c.stroke(), c.moveTo(t - G, p), c.lineTo(t - G, n), c.stroke());
                c.restore();
                ...
                0 < aa &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(N(E, aa)),
                  (c.strokeStyle = R),
                  (c.lineWidth = aa),
                ...
                w &&
                  ...
                  (b.strokeStyle = e),
                  (b.lineWidth = Ba),
                  0 < Ba && (b.moveTo(t - F - G, k), b.lineTo(t - F - G, Math.max(h, p)), b.stroke(), b.moveTo(t - F - G, Math.min(h, p)), b.lineTo(t - F - G, n), b.stroke()),
                  V(b, D, Math.max(k, n), A, Math.min(k, n), e, 0, null, !1, !1, !1, !1),
                  0 < aa && (b.beginPath(), (b.lineWidth = aa), b.moveTo(t + Y / 2, p - fa), b.lineTo(t - Y / 2, p - fa), b.stroke(), b.moveTo(t + Y / 2, h + fa), b.lineTo(t - Y / 2, h + fa), b.stroke()));
                (y[l].indexLabel || z.indexLabel || y[l].indexLabelFormatter || z.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: z.type,
                    dataPoint: y[l],
                    dataSeries: z,
                    point: { x: D + (A - D) / 2, y: a.axisY.reversed ? h : p },
                    direction: 1,
                    bounds: { x1: D, y1: Math.min(h, p), x2: A, y2: Math.max(h, p) },
                    color: e,
                  });
              }
        }
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < g.length)
            for (var s = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
              if (
                (g[f].getTime ? (h = g[f].x.getTime()) : (h = g[f].x), !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1])
              ) {
                ...
                V(c, a.axisX.reversed ? v : m, l, a.axisX.reversed ? m : v, t, b, 0, b, s, s, !1, !1, q.fillOpacity);
                b = Q(u);
                ...
                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter)
                  this._indexLabels.push({
                    ...
                    dataSeries: q,
                    indexKeyword: 0,
                    point: { x: m + (v - m) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l },
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          var y = a.dataSeriesIndexes[z],
            C = this.data[y],
            D = C.dataPoints,
            A = r(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/gi) && C._linkedSeries.visible ? !0 : !1,
            F = 0;
          if (A)
            for (e = C._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/gi) || !this.data[u].visible || (this.data[u].type.match(/(stacked)/gi) && F) || (this.data[u].type.match(/(range)/gi) && (f = !0), F++);
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
          ...
          u = this.options.dataPointWidth ? this.dataPointWidth : (0.9 * (((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range))) / (A ? v : 1))) << 0;
          ...
          if (0 < D.length)
            for (var E = C._colorSet, t = 0; t < D.length; t++) {
              ...
              R.length = "number" === typeof R.length ? (0 >= R.length ? 0 : R.length >= u ? u : R.length) : "string" === typeof R.length ? ((parseInt(R.length) * u) / 100 > u ? u : (parseInt(R.length) * u) / 100 > u) : u;
              ...
              if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) && !r(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                ...
                b ? (p = ja) : (g = ja);
                b
                  ? ((q = a.axisX.reversed ? (k + ((A ? v : 1) * u) / 2 - (A ? F - 1 : 0) * u) << 0 : (k - ((A ? v : 1) * u) / 2 + (A ? F - 1 : 0) * u) << 0), (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((n = a.axisX.reversed ? (h + ((A ? v : 1) * u) / 2 - (A ? F - 1 : 0) * u) << 0 : (h - ((A ? v : 1) * u) / 2 + (A ? F - 1 : 0) * u) << 0), (p = a.axisX.reversed ? (n - u) << 0 : (n + u) << 0));
                !b && q > g && ((ja = q), (q = g), (g = ja));
                b && n > p && ((ja = n), (n = p), (p = ja));
                ja = C.dataPointIds[t];
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < s.length) {
            ...
            for (f = 0; f < s.length; f++)
              if (
                (s[f].getTime ? (k = s[f].x.getTime()) : (k = s[f].x), !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1])
              ) {
                ...
                if (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter)
                  this._indexLabels.push({
                    ...
                    dataSeries: g,
                    indexKeyword: 0,
                    point: { x: s[f].y[1] >= s[f].y[0] ? l : t, y: h + (v - h) / 2 },
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < p.length) {
            ...
            for (var R = !0; g < p.length; g++)
              if (((u = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !R)))))
                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                  ...
                  q || R
                    ? (n.connectNullData && !q
                        ? (b.setLineDash && (n.options.nullDataLineDashType || (A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType)) && ((h[h.length - 1].newLineDashArray = F), (A = n.nullDataLineDashType), b.setLineDash(x)),
                          b.lineTo(s, m),
                          w && e.lineTo(s, m),
                          h.push({ x: s, y1: m, y2: r }))
                        : (b.beginPath(), b.moveTo(s, m), (z = { x: s, y: m }), (h = []), h.push({ x: s, y1: m, y2: r }), w && (e.beginPath(), e.moveTo(s, m))),
                      (R = q = !1))
                    : (b.lineTo(s, m), h.push({ x: s, y1: m, y2: r }), w && e.lineTo(s, m), 0 == g % 250 && d());
                  u = n.dataPointIds[g];
                  this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: s, y1: m, y2: r };
                  g < p.length - 1 &&
                    (D !== (p[g].lineColor || v) || A !== (p[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (D = p[g].lineColor || v),
                    ...
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((A = p[g].lineDashType), (h[h.length - 1].newLineDashArray = N(A, n.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                        : ((A = n.lineDashType), (h[h.length - 1].newLineDashArray = F), b.setLineDash(F))));
                  if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                    ...
                    aa = n.getMarkerProperties(g, s, m, b);
                    f.push(aa);
                    E = Q(u);
                  ...
                  if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter)
                    this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: s, y: m }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: y }),
                      this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 1, point: { x: s, y: r }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? 1 : -1, color: y });
                } else R || q || d(), (R = !0);
            d();
            $.drawMarkers(f);
          }
          ...
          if (0 < k.lineThickness) {
            ...
            for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
              if (r[g].newStrokeStyle || r[g].newLineDashArray)
                b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), r[g].newStrokeStyle && (b.strokeStyle = r[g].newStrokeStyle), r[g].newLineDashArray && b.setLineDash(r[g].newLineDashArray);
              b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
            }
            d = v(r, 2);
            b.moveTo(d[0].x, d[0].y);
            ...
            for (g = !1; p < n.length; p++)
              if (((q = n[p].x.getTime ? n[p].x.getTime() : n[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                  ...
                  x[x.length] = { x: q, y: m };
                  p < n.length - 1 &&
                    (y !== (n[p].lineColor || z) || C !== (n[p].lineDashType || k.lineDashType)) &&
                    ((y = n[p].lineColor || z),
                    (r[r.length - 1].newStrokeStyle = y),
                    b.setLineDash && (n[p].lineDashType ? ((C = n[p].lineDashType), (r[r.length - 1].newLineDashArray = N(C, k.lineThickness))) : ((C = k.lineDashType), (r[r.length - 1].newLineDashArray = D))));
                  ...
                  if (n[p].indexLabel || k.indexLabel || n[p].indexLabelFormatter || k.indexLabelFormatter)
                    this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: n[p].y[0] <= n[p].y[1] ? -1 : 1, color: u }),
                      this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: m }, direction: n[p].y[0] <= n[p].y[1] ? 1 : -1, color: u });
                  g = !1;
                } else
                  0 < p &&
                    !g &&
                    (k.connectNullData ? b.setLineDash && 0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = A), (C = k.nullDataLineDashType)) : (d(D, z), (r = []), (x = []))),
                    (g = !0);
            d(D, z);
            $.drawMarkers(f);
          }
          ...
          if (0 < v.length)
            for (var y = 5 < q && r.bevelEnabled ? !0 : !1, C = !1, D = null, A = null, l = 0; l < v.length; l++)
              if ((v[l].getTime ? (n = v[l].x.getTime()) : (n = v[l].x), "number" !== typeof v[l].y)) {
                if (0 < l && !C && r.connectNullData) var x = r.options.nullDataLineDashType || !v[l - 1].lineDashType ? r.nullDataLineDashType : v[l - 1].lineDashType;
                C = !0;
              } else {
                ...
                e = Q(e);
                w && V(this._eventManager.ghostCtx, a.axisX.reversed ? F : h, m, a.axisX.reversed ? h : F, k, e, 0, null, !1, !1, !1, !1);
                var aa,
                  R = h;
                ...
                0 < l &&
                  D &&
                  (!C || r.connectNullData) &&
                  (C && c.setLineDash && c.setLineDash(N(x, u)), c.beginPath(), c.moveTo(D, A - z), c.lineTo(R, aa - z), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(D, A - z), b.lineTo(R, aa - z), 0 < u && b.stroke()));
                C = !1;
                D = F;
                A = 0 < v[l].y ? m : k;
                R = v[l].lineDashType ? v[l].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash";
                ...
                (v[l].indexLabel || r.indexLabel || v[l].indexLabelFormatter || r.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: v[l],
                    dataSeries: r,
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (k && n) {
          ...
          for (e = 0; e < n.length; e++)
            (h = g[(d + e) % n.length]), 1 < b && h.midAngle > (3 * Math.PI) / 2 - u && h.midAngle < (3 * Math.PI) / 2 + u && (l <= b / 2 && !p ? ((h.hemisphere = "left"), l++) : ((h.hemisphere = "right"), (p = !0)));
        }
      }
      function c(a) {
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            var e = 0.07 * A * Math.cos(g[b].midAngle),
              ...
              l = !1;
            if (n[b].exploded) {
              if (1e-9 < Math.abs(g[b].center.x - (y.x + e)) || 1e-9 < Math.abs(g[b].center.y - (y.y + f))) (g[b].center.x = y.x + e * a), (g[b].center.y = y.y + f * a), (l = !0);
            } else if (0 < Math.abs(g[b].center.x - y.x) || 0 < Math.abs(g[b].center.y - y.y)) (g[b].center.x = y.x + e * (1 - a)), (g[b].center.y = y.y + f * (1 - a)), (l = !0);
        ...
        for (b = b = 0; b < n.length; b++)
          (c = g[b]),
            c.indexLabelText &&
              ...
              (d = 0),
              (d = "left" === c.hemisphere ? ("inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + p) : -c.indexLabelTextBlock.width / 2) : "inside" !== k.indexLabelPlacement ? p : -c.indexLabelTextBlock.width / 2),
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                ((d = c.center.x + A * Math.cos(c.midAngle)),
                (e = c.center.y + A * Math.sin(c.midAngle)),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < n.length) {
          ...
          var q = 0,
            ...
            t = (q = q = 0);
          0 > c
            ? p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 > k && p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c < k && (c = -(k - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c)))
            : p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 < k && p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c > h && (c = p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c - h);
          ...
          0 > c
            ? ((h = "right" === p.hemisphere ? t : q),
              ...
              null !== h &&
                ((t = -c),
                (c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2)),
                c - t < s && ((k = -t), (h = f(h, k, d + 1)), +h.toFixed(z) > +k.toFixed(z) && (l = c > s ? -(c - s) : -(t - (h - k))))))
            : 0 < c &&
              ((h = "right" === p.hemisphere ? q : t),
              (l = c),
              null !== h &&
                ((t = c),
                (c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2)),
                c - t < s && ((k = t), (h = f(h, k, d + 1)), +h.toFixed(z) < +k.toFixed(z) && (l = c > s ? c - s : t - (k - h)))));
          l &&
            ((d = p.indexLabelTextBlock.y + l),
            (c = 0),
            (c = "right" === p.hemisphere ? y.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - y.y, 2)) : y.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - y.y, 2))),
            p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u
              ? ((k = (a - 1 + g.length) % g.length),
                (k = g[k]),
                (a = g[(a + 1 + g.length) % g.length]),
                "left" === p.hemisphere && "right" === k.hemisphere && c > k.indexLabelTextBlock.x
                  ? (c = k.indexLabelTextBlock.x - 15)
                  : "right" === p.hemisphere && "left" === a.hemisphere && c < a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x + 15))
              : p.midAngle > (3 * Math.PI) / 2 - u &&
                p.midAngle < (3 * Math.PI) / 2 + u &&
                ((k = (a - 1 + g.length) % g.length),
                (k = g[k]),
                (a = g[(a + 1 + g.length) % g.length]),
                "right" === p.hemisphere && "left" === k.hemisphere && c < k.indexLabelTextBlock.x
                  ? (c = k.indexLabelTextBlock.x + 15)
                  : "left" === p.hemisphere && "right" === a.hemisphere && c > a.indexLabelTextBlock.x && (c = a.indexLabelTextBlock.x - 15)),
            (p.indexLabelTextBlock.y = d),
            (p.indexLabelTextBlock.x = c),
            (p.indexLabelAngle = Math.atan2(p.indexLabelTextBlock.y - y.y, p.indexLabelTextBlock.x - y.x)));
        }
        return l;
      }
      function l() {
        ...
        for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
              ...
              if (null !== u) {
                ...
                if (0 > C) {
                  ...
                  var D = -1 * (C - r),
                    J = (E = 0);
                  "right" === h.hemisphere
                    ? ((E = f(a, r)), (D = -1 * (C - E)), (J = f(u, D)), +J.toFixed(z) < +D.toFixed(z) && +E.toFixed(z) <= +r.toFixed(z) && f(a, -(D - J)))
                    : ((E = f(u, r)), (D = -1 * (C - E)), (J = f(a, D)), +J.toFixed(z) < +D.toFixed(z) && +E.toFixed(z) <= +r.toFixed(z) && f(u, -(D - J)));
                }
              }
            }
          } else
          ...
          for (a = 0; a < n.length; a++)
            if (((h = g[a]), (u = h.indexLabelTextBlock.measureText()), 0 !== u.height && 0 !== u.width))
              (u = u = 0),
                "right" === h.hemisphere ? ((u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p)), (u *= -1)) : (u = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p)),
                0 < u &&
                  (!l &&
                    h.indexLabelText &&
                    ((r = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1),
                    0.3 * h.indexLabelTextBlock.maxWidth > r ? (h.indexLabelText = "") : (h.indexLabelTextBlock.maxWidth = 0.85 * r),
                    0.3 * h.indexLabelTextBlock.maxWidth < r && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)),
                  Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - y.y) < A || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - y.y) < A) &&
                  ((u /= Math.abs(Math.cos(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)),
                (u = u = 0),
                0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                  ? ((u = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5)), (u *= -1))
                  : (u = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5)),
                0 < u &&
                  (!l && h.indexLabelText && ((r = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, u * r) && f(a, 2 * r)),
                  Math.abs(h.indexLabelTextBlock.x - y.x) < A && ((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var D = 0; D < n.length; D++)
          (C += Math.abs(n[D].y)),
            !a && "undefined" !== typeof n[D].indexLabel && null !== n[D].indexLabel && 0 < n[D].indexLabel.toString().length && (a = !0),
            !a && "undefined" !== typeof n[D].label && null !== n[D].label && 0 < n[D].label.toString().length && (a = !0);
        if (0 !== C) {
          ...
          this.pieDoughnutClickHandler = function (a) {
            m.isAnimating ||
              (!r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick) ||
              ((a = a.dataPoint),
    ...
    m.prototype.renderFunnel = function (a) {
      function d() {
        ...
        if (0 === a) return -1;
        for (c = b[0] = 0; c < z.length; c++) b.push((Math.abs(z[c].y) * F) / a);
        return b;
      }
      function c() {
        var a = U,
        ...
        f = Math.abs(f);
        f = d + f;
        for (var d = [], g = 0, k = 0; k < z.length; k++) {
          if ("undefined" === typeof z[k].y) return -1;
          z[k].y = "number" === typeof z[k].y ? z[k].y : 0;
          g += Math.abs(z[k].y);
        }
        if (0 === g) return -1;
        for (var l = (d[0] = 0), h = 0, n, p, b = b - a, l = !1, k = 0; k < z.length; k++)
          (a = (Math.abs(z[k].y) * f) / g),
            l
              ? (n = 0 == Number(c.toFixed(3)) ? 0 : a / c)
              : ((p = V * V * b * b - 4 * Math.abs(V) * a),
                0 > p
                  ? ((p = c), (l = ((b + p) * (e - h)) / 2), (a -= l), (n = e - h), (h += e - h), (n += 0 == p ? 0 : a / p), (h += a / p), (l = !0))
                  : ((n = (Math.abs(V) * b - Math.sqrt(p)) / 2),
                    (p = b - (2 * n) / Math.abs(V)),
                    (h += n),
                    h > e && ((h -= n), (p = c), (l = ((b + p) * (e - h)) / 2), (a -= l), (n = e - h), (h += e - h), (n += a / p), (h += a / p), (l = !0)),
                    (b = p))),
            d.push(n);
        return d;
      }
      function b() {
        if (u && z) {
          for (var a, b, c, d, e, f, k, l, h, n, p, q, t, m, s, B = [], y = [], v = { percent: null, total: null }, C = null, A = 0; A < z.length; A++)
            (s = O[A]), (s = "undefined" !== typeof s.x5 ? (s.y2 + s.y4) / 2 : (s.y2 + s.y3) / 2), (s = g(s).x2 + 1), (B[A] = M - s - X);
          s = 0.5 * X;
          for (var A = 0, D = z.length - 1; A < z.length || 0 <= D; A++, D--) {
            ...
            "inside" === u.indexLabelPlacement &&
              ((B[A] = A !== ca ? (u.reversed ? O[A].x2 - O[A].x1 : O[A].x3 - O[A].x4) : O[A].x3 - O[A].x6), 20 > B[A] && ((B[A] = A !== ca ? (u.reversed ? O[A].x3 - O[A].x4 : O[A].x2 - O[A].x1) : O[A].x2 - O[A].x1), (B[A] /= 2)));
            t = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : B[A];
            if (t > B[A] || 0 > t) t = B[A];
            ...
            c = new ia(T, {
              ...
              backgroundColor: d,
              maxWidth: t,
              maxHeight: !1 === y[A] ? (q ? 4.28571429 * f : 1.5 * f) : y[A],
              text: b,
              padding: da,
            });
            c.measureText();
      ...
      function e() {
        ...
        e = !1;
        c = 0;
        for (var g, k = M - $ - X / 2, k = u.options.indexLabelMaxWidth ? (u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth) : k, l = I.length - 1; 0 <= l; l--) {
          g = z[I[l].id];
          c = I[l];
          d = c.textBlock;
        ...
        if (e)
          for (l = I.length - 1; 0 <= l; l--)
            (a = O[l]),
              ...
              u.reversed
                ? (I[l].textBlock.y + I[l].height > ma + C && (I[l].textBlock.y = ma + C - I[l].height), I[l].textBlock.y < ra - C && (I[l].textBlock.y = ra - C))
                : (I[l].textBlock.y < ma - C && (I[l].textBlock.y = ma - C), I[l].textBlock.y + I[l].height > ra + C && (I[l].textBlock.y = ra + C - I[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < O.length; e++)
            0 == I[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                u.reversed
                  ? (I[e].textBlock.y + I[e].height > ma + C && (I[e].textBlock.y = ma + C - I[e].height), I[e].textBlock.y < ra - C && (I[e].textBlock.y = ra - C))
                  : (I[e].textBlock.y < ma - C && (I[e].textBlock.y = ma - C), I[e].textBlock.y + I[e].height > ra + C && (I[e].textBlock.y = ra + C - I[e].height)));
        else
          for (e = 0; e < O.length; e++)
            0 == I[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                (c = I[e].height),
                (d = I[e].width),
                b >= c ? ((b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2), (c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2), (I[e].textBlock.x = b), (I[e].textBlock.y = c)) : (I[e].isDirty = !0));
      }
      function l() {
        function a(b, c) {
          var d;
          ...
          for (var l, h = 1; h < k; h++) {
            ...
            for (var t = I.length - 1; 0 <= t; t--)
              !I[t].isDirty &&
                ...
                ((l = q(t)), !(l >= I.length - 1) && I[t].textBlock.y + I[t].height + da > I[l].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y + I[t].height - e > e - I[t].textBlock.y ? e + 1 : e - I[t].height - 1));
          }
        ...
        for (var d, e, f, g, k, l, n = 1, m = 0; m < 2 * n; m++) {
          for (
            ...
            (f = I[s]),
            (g = f.textBlock),
            (l = (k = q(s) < O.length ? I[q(s)] : null) ? k.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty && k && e + d + da > +l.y.toFixed(6) && ((d = g.y + d + da - l.y), (e = a(s, -d)), e < d && (0 < e && (d -= e), (e = a(q(s), d)), e != d)));
            s--
          );
          b();
        }
      ...
      function h(a, b) {
        return (b < O.length ? I[b].textBlock.y : u.reversed ? ma + C : ra + C) - (0 > a ? (u.reversed ? ra - C : ma - C) : I[a].textBlock.y + I[a].height + da);
      }
      function m(a, b, c) {
        var d,
          e,
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            for (e = 0; e < O.length; e++) oa(d, O[e], u.fillOpacity);
            v(d);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]], z = u.dataPoints, y = this.plotArea, C = 0.025 * y.width, D = 0.01 * y.width, A = 0, F = y.height - 2 * C, E = Math.min(y.width - 2 * D, 2.8 * y.height), J = !1, H = 0;
          H < z.length;
          H++
        )
          if (
            (!J && "undefined" !== typeof z[H].indexLabel && null !== z[H].indexLabel && 0 < z[H].indexLabel.toString().length && (J = !0),
            !J && "undefined" !== typeof z[H].label && null !== z[H].label && 0 < z[H].label.toString().length && (J = !0),
            (!J && "function" === typeof u.indexLabelFormatter) || "function" === typeof z[H].indexLabelFormatter)
          )
            J = !0;
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== z.length) {
          ...
          var X = (30 * (M - a)) / 100;
          "funnel" === u.type
            ? ((P = r(u.options.neckHeight) ? 0.35 * F : u.neckHeight),
              (G = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth),
              "string" === typeof P && P.match(/%$/) ? ((P = parseInt(P)), (P = (P * F) / 100)) : (P = parseInt(P)),
              "string" === typeof G && G.match(/%$/) ? ((G = parseInt(G)), (G = (G * a) / 100)) : (G = parseInt(G)),
              P > F ? (P = F) : 0 >= P && (P = 0),
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === u.type && ((G = P = 0), (u.reversed = u.reversed ? !1 : !0));
          var D = H + a / 2,
            U = H,
            $ = H + a,
            ma = u.reversed ? Q : Y,
          ...
          if (-1 !== H) {
            if (u.reversed) for (E.push(Z), G = H.length - 1; 0 < G; G--) (Z += H[G]), E.push(Z);
            else for (G = 0; G < H.length; G++) (Z += H[G]), E.push(Z);
            if (u.reversed) for (G = 0; G < H.length; G++) E[G] < wa ? (a.push(L), D.push(ba), (ca = G)) : (a.push((E[G] - ma + V * U) / V), D.push((E[G] - ma + ea * $) / ea));
            else for (G = 0; G < H.length; G++) E[G] < wa ? (a.push((E[G] - ma + V * U) / V), D.push((E[G] - ma + ea * $) / ea), (ca = G)) : (a.push(L), D.push(ba));
            for (G = 0; G < H.length - 1; G++)
              (Z = u.reversed ? (z[z.length - 1 - G].color ? z[z.length - 1 - G].color : u._colorSet[(z.length - 1 - G) % u._colorSet.length]) : z[G].color ? z[G].color : u._colorSet[G % u._colorSet.length]),
                G === ca
                  ? O.push({ x1: a[G], y1: E[G], x2: D[G], y2: E[G], x3: ba, y3: wa, x4: D[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1], x6: L, y6: wa, id: G, height: E[G + 1] - E[G], color: Z })
                  : O.push({ x1: a[G], y1: E[G], x2: D[G], y2: E[G], x3: D[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: Z });
            var da = 2,
              I = [],
              ha = !1,
              W = [],
            ...
            if (J && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
              l();
              for (G = 0; G < z.length; G++) I[G].isDirty || ((a = I[G].textBlock.x + I[G].width), (a = (M - a) / 2), 0 == G && (A = a), A > a && (A = a));
              for (G = 0; G < O.length; G++) (O[G].x1 += A), (O[G].x2 += A), (O[G].x3 += A), (O[G].x4 += A), O[G].x5 && ((O[G].x5 += A), (O[G].x6 += A)), (I[G].textBlock.x += A);
            }
            ...
            if (!J)
              for (G = 0; G < z.length; G++) (A = u.dataPointIds[G]), (a = { id: A, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[u.reversed ? z.length - 1 - G : G] }), (x._eventManager.objectMap[A] = a);
            ...
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (!ha && !x.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && ((b = u.reversed ? z.length - 1 - a.dataPointIndex : a.dataPointIndex), 0 <= b)) {
                a = b;
                if ("funnel" === u.type || "pyramid" === u.type) u.reversed ? (z[z.length - 1 - a].exploded = z[z.length - 1 - a].exploded ? !1 : !0) : (z[a].exploded = z[a].exploded ? !1 : !0);
                m(x, b, 500);
              }
            };
            return {
        ...
        if (p.dataPoints && p.dataPoints.length)
          if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
            var q = (p.legendMarkerType = p.legendMarkerType
              ...
              s = (p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? (r(p.whiskerColor) ? p._colorSet[0] : p.whiskerColor) : p._colorSet[0]),
            ...
            q = { markerType: q, markerColor: s, text: g, textBlock: null, chartType: p.type, markerSize: w, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: v, markerBorderThickness: u };
            m.push(q);
          } else
            for (var z = 0; z < p.dataPoints.length; z++) {
              var y = p.dataPoints[z],
                ...
                u = y.legendMarkerBorderThickness ? y.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : y.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0,
        ...
        for (n = 0; n < m.length; n++) {
          ...
          if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
            if ("horizontal" === this.orientation) {
              ...
              if (!p || p.width + Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
              ...
              (q.textBlock = new ia(this.ctx, {
                ...
                q.textBlock.measureText(),
                null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                this.height < l - this.lineHeight ? ((p = { items: [], width: 0 }), k.push(p)) : ((p = k[z]), (z = (z + 1) % k.length)),
        ...
        for (var k = l[m], n = 0, p = 0; p < k.items.length; p++) {
          ...
          if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType)
            (this.ctx.strokeStyle = q.lineColor),
              ...
              this.ctx.beginPath(),
              this.ctx.moveTo(g - 0.1 * this.lineHeight, s + this.lineHeight / 2),
              this.ctx.lineTo(g + 0.85 * this.lineHeight, s + this.lineHeight / 2),
              this.ctx.stroke(),
          ...
          if (q) {
            switch (this.type) {
              ...
              case "bubble":
                r = q.size;
                s = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                s <= r / 2 && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: s }), (h = !0));
                break;
              case "pie":
              case "doughnut":
                r = q.center;
                ...
                s < q.radius &&
                  s > w &&
                  ((s = Math.atan2(d - r.y, a - r.x)),
                  0 > s && (s += 2 * Math.PI),
                  (s = Number(((((180 * (s / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                  (r = Number(((((180 * (q.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                  (w = Number(((((180 * (q.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
                  0 === w && 1 < q.endAngle && (w = 360),
                  r >= w && 0 !== g.y && ((w += 360), s < r && (s += 360)),
                  s > r && s < w && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
                break;
              case "funnel":
              case "pyramid":
                s = q.funnelSection;
                d > s.y1 &&
                  ...
                  (s.y6
                    ? d > s.y6
                      ? ((f = s.x6 + ((s.x5 - s.x6) / (s.y5 - s.y6)) * (d - s.y6)), (s = s.x3 + ((s.x4 - s.x3) / (s.y4 - s.y3)) * (d - s.y3)))
                      : ((f = s.x1 + ((s.x6 - s.x1) / (s.y6 - s.y1)) * (d - s.y1)), (s = s.x2 + ((s.x3 - s.x2) / (s.y3 - s.y2)) * (d - s.y2)))
                    : ((f = s.x1 + ((s.x4 - s.x1) / (s.y4 - s.y1)) * (d - s.y1)), (s = s.x2 + ((s.x3 - s.x2) / (s.y3 - s.y2)) * (d - s.y2))),
                  a > f && a < s && (b.push({ dataPoint: g, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), (h = !0)));
                break;
              case "boxAndWhisker":
                if (
    ...
    F.prototype.createExtraLabelsForLog = function (a) {
      ...
      if (!(5 < a)) {
        ...
        if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
          for (var c = F.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c)
    ...
    F.prototype.createLabels = function () {
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        for (
          this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval),
            e = Xa(new Date(this.viewportMaximum), this.interval, this.intervalType),
            g = q,
            c = this.intervalStartPosition;
          c < e;
      ...
      if ("bottom" === this._position || "top" === this._position)
        (h =
          this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
            ? (this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) / Math.log(this.range)
            : (this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * T[this.intervalType + "Duration"] * this.interval),
        ...
        (h =
          this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
            ? (this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) / Math.log(this.range)
            : (this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * T[this.intervalType + "Duration"] * this.interval),
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
          ...
          if (((f = (0.9 * h) >> 0), (q = 0), !this.chart.panEnabled && 1 <= this._labels.length)) {
            ...
            for (c = 0; c < this._labels.length; c++)
              if (!this._labels[c].breaksLabelType) {
                ...
                for (var v, g = a.text.split(" "), b = 0; b < g.length; b++)
                  (n = g[b]), (this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily), (n = this.ctx.measureText(n)), n.width > q && ((v = c), (q = n.width));
              }
            c = 0;
                  ...
                  if (
                    ...
                    this.labelWrap
                      ? r(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n)), (this.sessionVariables.labelWrap = this.labelWrap), d && (s.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                        : ((this.sessionVariables.labelWrap = this.labelWrap),
                      ...
                      ? ((this.sessionVariables.labelWrap = this.labelWrap),
                        (this.sessionVariables.labelMaxHeight = l),
                        (this.sessionVariables.labelMaxWidth = f),
                        d && (s.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = n)))
                      : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                        (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                        (this.sessionVariables.labelMaxHeight = l),
                        (this.sessionVariables.labelWrap = this.labelWrap));
                    ...
                    if (r(this.options.labelWrap))
                      if (!r(this.options.labelMaxWidth))
                        ...
                        if (((b = (s.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                          b - 2 * f > p &&
                            ((p = b - 2 * f),
                            b >= 2 * f && b < 2.2 * f
                              ? ((this.sessionVariables.labelMaxWidth = f),
                                r(this.options.labelFontSize) && 12 < g && ((g = Math.floor((12 / 13) * g)), a.measureText()),
                                (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                (this.sessionVariables.labelAngle = this.labelAngle))
                              : b >= 2.2 * f && b < 2.8 * f
                              ...
                              ? ((this.sessionVariables.labelMaxWidth = Math.max(f, q)),
                                ...
                                r(this.options.labelFontSize) && 12 < this.labelFontSize && ((this.labelFontSize = Math.floor((12 / 13) * this.labelFontSize)), a.measureText()),
                                (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                (this.sessionVariables.labelAngle = this.labelAngle))
                              : b >= 3.2 * f && b < 3.6 * f
                              ? ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelWrap = !0), (this.sessionVariables.labelMaxWidth = n), (this.sessionVariables.labelFontSize = this.labelFontSize))
                              : b > 3.6 * f && b < 5 * f
                              ? (r(this.options.labelFontSize) && 12 < g && ((g = Math.floor((12 / 13) * g)), a.measureText()),
                                (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize),
                                (this.sessionVariables.labelWrap = !0),
                          ...
                          v === c &&
                          ((0 === v && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p) ||
                            (v === this._labels.length - 1 && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p) ||
                            (0 < v && v < this._labels.length - 1 && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > p))
                        )
                          (p = 0 === v ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f : q + this._labels[v - 1].textBlock.measureText().width - 2 * f),
                            (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize),
                            (this.sessionVariables.labelWrap = !0),
                            (this.sessionVariables.labelAngle = -25),
                            (this.sessionVariables.labelMaxWidth = n);
                        else if (0 === p)
                          for (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++)
                            (a = this._labels[b].textBlock),
                              ...
                              b < this._labels.length - 1 &&
                                ...
                                (d = d.measureText()),
                                (s.width + d.width) >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25));
                  }
                else
                  ((this.sessionVariables.labelAngle = this.labelAngle),
                  (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)), b)),
                  ...
                  r(this.options.labelWrap))
                    ? r(this.options.labelWrap) &&
                      (this.labelWrap && !r(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelWrap = this.labelWrap), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : n), (this.sessionVariables.labelMaxHeight = l))
                        : ((this.sessionVariables.labelAngle = this.labelAngle),
                          (this.sessionVariables.labelMaxWidth = n),
                    ...
                    : (this.options.labelWrap
                        ...
                        : (r(this.options.labelMaxWidth), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : n), (this.sessionVariables.labelWrap = this.labelWrap)),
                      (this.sessionVariables.labelMaxHeight = l));
              }
            for (b = 0; b < this._labels.length; b++)
              (a = this._labels[b].textBlock),
            ...
            for (c = 0; c < this._labels.length; c++)
              (a = this._labels[c].textBlock),
                (a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? (r(this.sessionVariables.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = f) : this.sessionVariables.labelMaxWidth) : this.options.labelMaxWidth),
                (a.fontSize = this.labelFontSize =
                  r(this.options.labelFontSize) ? (r(this.sessionVariables.labelFontSize) ? (this.sessionVariables.labelFontSize = this.labelFontSize) : this.sessionVariables.labelFontSize) : this.options.labelFontSize),
                (a.angle = this.labelAngle = r(this.options.labelAngle) ? (r(this.sessionVariables.labelAngle) ? (this.sessionVariables.labelAngle = this.labelAngle) : this.sessionVariables.labelAngle) : this.labelAngle),
                (a.wrap = this.labelWrap = r(this.options.labelWrap) ? (r(this.sessionVariables.labelWrap) ? (this.sessionVariables.labelWrap = this.labelWrap) : this.sessionVariables.labelWrap) : this.options.labelWrap),
                (a.maxHeight = r(this.sessionVariables.labelMaxHeight) ? (this.sessionVariables.labelMaxHeight = l) : this.sessionVariables.labelMaxHeight),
                a.measureText();
        else if ("left" === this._position || "right" === this._position)
          if (
            ((f = r(this.options.labelMaxWidth) ? (0.3 * this.chart.width) >> 0 : this.options.labelMaxWidth),
            (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? (0.3 * this.chart.height) >> 0 : 1.5 * this.labelFontSize),
                ...
                r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                  ? r(this.options.labelWrap)
                    ? r(this.options.labelWrap) &&
                      (r(this.options.labelMaxWidth)
                        ? r(d) ||
                          ((h = (s.height + d.height) >> 0),
                          h - 2 * l > q &&
                            ((q = h - 2 * l),
                            h >= 2 * l && h < 2.4 * l
                              ? (r(this.options.labelFontSize) && 12 < this.labelFontSize && ((this.labelFontSize = Math.floor((12 / 13) * this.labelFontSize)), a.measureText()),
                                (this.sessionVariables.labelMaxHeight = l),
                                (this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize))
                              : h >= 2.4 * l && h < 2.8 * l
                  ...
                  ? r(this.options.labelWrap) &&
                    (this.labelWrap && !r(this.options.labelMaxWidth)
                      ...
                      : ((this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f),
                        ...
                        r(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle)))
                  : this.options.labelWrap
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === f.labelPlacement) {
          ...
          if ("bottom" === this._position || "top" === this._position)
            r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight)
              ? (x = this.sessionVariables.stripLineLabelMaxHeight)
              : (this.sessionVariables.stripLineLabelMaxHeight = x = f.labelWrap ? (0.8 * this.chart.height) >> 0 : 1.5 * this.labelFontSize);
          ...
          (l = "bottom" === this._position || "top" === this._position ? (0.9 * this.chart.width) >> 0 : (0.9 * this.chart.height) >> 0),
            (x = r(f.options.labelWrap) || f.labelWrap ? ("bottom" === this._position || "top" === this._position ? (0.8 * this.chart.width) >> 0 : (0.8 * this.chart.height) >> 0) : 1.5 * this.labelFontSize),
            r(f.labelBackgroundColor) && (r(f.startValue) && 0 !== f.startValue ? (f.labelBackgroundColor = w ? "transparent" : null) : (f.labelBackgroundColor = "#EEEEEE"));
        a = new ia(this.ctx, {
          x: 0,
          y: 0,
    ...
    F.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (var s = q[g].scaleBreaks._appliedBreaks, w = 0; w < s.length && !(s[w].startValue > q[g].viewportMaximum); w++)
            s[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
      for (var v = (w = 0), u = 0, z = 0, y = 0, x = 0, D = 0, A, F, E = (h = 0), H, J, K, s = (H = J = K = !1), g = 0; g < q.length; g++)
        q[g] &&
          q[g].title &&
      ...
      if ("normal" === e) {
        for (var z = [], y = [], x = [], D = [], M = [], N = [], P = [], Q = []; 4 > w; ) {
          var G = 0,
            ...
            O = 0,
            $ = 0;
          if (c && 0 < c.length) for (x = [], g = O = 0; g < c.length; g++) x.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (O += x[g]), (L += c[g] && !n.isNavigator ? c[g].margin : 0);
          else x.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(x);
          if (b && 0 < b.length) for (D = [], g = $ = 0; g < b.length; g++) D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), ($ += D[g]), (Z += b[g] ? b[g].margin : 0);
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (v = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                  (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                !a[g] ||
                  !a[g].labelAutoFit ||
                  r(A) ||
                  r(F) ||
                  ...
                  ((h = 0),
                  0 < a[g].labelAngle
                    ? F + u > m && (h += 0 < a[g].labelAngle ? F + u - m - $ : 0)
                    : 0 > a[g].labelAngle
                    ? A - v < l && A - v < a[g].viewportMinimum && (E = l - (L + a[g].tickLength + x + A - v + a[g].labelFontSize / 2))
                    : 0 === a[g].labelAngle && (F + u > m && (h = F + u / 2 - m - $), A - v < l && A - v < a[g].viewportMinimum && (E = l - L - a[g].tickLength - x - A + v / 2)),
                  a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h
                    ? (m -= h)
                    : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E
                    ? (l += E)
                    : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E), 0 < h && (m -= h))),
                n.panEnabled ? (U = r(n.sessionVariables.axisX.height) ? (n.sessionVariables.axisX.height = U) : n.sessionVariables.axisX.height) : (n.sessionVariables.axisX.height = U),
                ...
                "inside" === a[g].labelPlacement &&
                  0 < g &&
                  ((a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + z[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0)),
                  (a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2)),
                (a[g].bounds = { x1: l, y1: h, x2: m, y2: k - (U + e - z[g] - G), width: m - l, height: k - h })),
                (G += z[g] + a[g].margin);
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + L)),
                ...
                d[g]._labels &&
                  ...
                  (v = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                  (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                n.panEnabled ? (V = r(n.sessionVariables.axisX2.height) ? (n.sessionVariables.axisX2.height = V) : n.sessionVariables.axisX2.height) : (n.sessionVariables.axisX2.height = V),
                (h = Math.round(f.y1)),
                (k = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = h + V + W - T),
                ...
                (d[g].bounds = { x1: l, y1: h + (V + W - y[g] - T), x2: m, y2: k, width: m - l, height: k - h }),
                (T += y[g] + d[g].margin);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (L = n.isNavigator ? 0 : 10),
                c[g] &&
                  ((l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                  (L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p),
                  (h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W)),
                  (m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                  (L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p),
                  (k = Math.round(f.y2 - U - e - L)),
                  (c[g].lineCoordinates = { x1: l - S, y1: h, x2: m - S, y2: k, height: Math.abs(k - h) }),
                  "inside" === c[g].labelPlacement &&
                    0 < g &&
                    ((c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (x[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                    (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                  (c[g].bounds = { x1: l - (x[g] + S), y1: h, x2: m, y2: k, width: m - l, height: k - h }),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              b[g] &&
                ...
                (m = Math.round(l)),
                (L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0),
                (h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W)),
                (L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0),
                (k = Math.round(f.y2 - (U + e + L))),
                (b[g].lineCoordinates = { x1: l + X, y1: h, x2: l + X, y2: k, height: Math.abs(k - h) }),
                "inside" === b[g].labelPlacement &&
                  0 < g &&
                  ((b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (D[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
                  (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                (b[g].bounds = { x1: l, y1: h, x2: m + (D[g] + X), y2: k, width: m - l, height: k - h }),
          ...
          if (0 < w) {
            if (a && 0 < a.length) for (g = 0; g < a.length; g++) s = M[w - 1][g] === M[w][g] ? !0 : !1;
            else s = !0;
            if (d && 0 < d.length) for (g = 0; g < d.length; g++) H = N[w - 1][g] === N[w][g] ? !0 : !1;
            else H = !0;
            if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[w - 1][g] === P[w][g] ? !0 : !1;
            else J = !0;
            if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = Q[w - 1][g] === Q[w][g] ? !0 : !1;
            else K = !0;
          }
          if (s && H && J && K) break;
          w++;
        ...
        for (N = []; 4 > w; ) {
          ...
          if (a && 0 < a.length) for (E = [], g = X = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (X += E[g]), (e += a[g] && !n.isNavigator ? a[g].margin : 0);
          else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          M.push(E);
          if (d && 0 < d.length) for (v = [], g = U = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (U += v[g]), (W += d[g] ? d[g].margin : 0);
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(f.x2 - U - W > n.width - 10 ? n.width - 10 : f.x2 - U - W)),
                c[g].labelAutoFit &&
                  !r(z) &&
                  (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, z) : 0 === c[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                (l = Math.round(f.x1 + X + e)),
                (m = Math.round(f.x2 - U - W > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - W)),
                b[g] && b[g].labelAutoFit && !r(x) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, x) : 0 === b[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m -= D / 2)),
          ...
          if (c && 0 < c.length) for (p = [], g = S = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (S += p[g] + c[g].margin), (L += c[g].margin);
          else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          F.push(p);
          if (b && 0 < b.length) for (A = [], g = T = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (T += A[g]), (Z += b[g].margin);
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              0 < c[g]._labels.length &&
                ...
                (z = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              b[g] &&
                ...
                (D = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))));
          if (n.panEnabled) for (g = 0; g < c.length; g++) p[g] = r(n.sessionVariables.axisY.height) ? (n.sessionVariables.axisY.height = p[g]) : n.sessionVariables.axisY.height;
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (h = Math.round(f.y2)),
                ...
                (c[g].bounds = { x1: l, y1: h - (p[g] + V + c[g].margin), x2: m, y2: k - (V + c[g].margin), width: m - l, height: p[g] }),
                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                (V += p[g] + c[g].margin);
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((h = Math.round(f.y1)),
                (k = Math.round(f.y1 + (A[g] + b[g].margin + G))),
                (b[g].lineCoordinates.y1 = k),
                (b[g].lineCoordinates.y2 = k),
                "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - A[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                (b[g].bounds = { x1: l, y1: h + (b[g].margin + G), x2: m, y2: k, width: m - l, height: T }),
                b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                (G += A[g] + b[g].margin));
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) {
              L = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize / 2 : 0;
              l = Math.round(f.x1 + e);
              ...
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && ((m = 0 > c[L].labelAngle ? Math.max(m, z) : 0 === c[L].labelAngle ? Math.max(m, z / 2) : m), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - X : l));
              if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((m = b[L].lineCoordinates.x1), (l = m - X));
              a[g].lineCoordinates = { x1: m - P, y1: h, x2: m - P, y2: k, height: Math.abs(k - h) };
              "inside" === a[g].labelPlacement &&
                0 < g &&
                ((a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (E[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0)),
                (a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2));
              a[g].bounds = { x1: m - (E[g] + P), y1: h, x2: m, y2: k, width: m - l, height: k - h };
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((m = b[L].lineCoordinates.x2), (l = m - U));
              d[g].lineCoordinates = { x1: m + Q, y1: h, x2: m + Q, y2: k, height: Math.abs(k - h) };
              "inside" === d[g].labelPlacement &&
                0 < g &&
                ((d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0)),
          ...
          if (0 < w) {
            ...
            if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = F[w - 1][g] === F[w][g] ? !0 : !1;
            else J = !0;
            if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = u[w - 1][g] === u[w][g] ? !0 : !1;
            else K = !0;
          }
          if (s && H && J && K) break;
          w++;
    ...
    F.render = function (a, d, c, b, e) {
      ...
      e.restore();
      if (a && 0 < a.length) for (l = 0; l < a.length; l++) a[l].renderGrid(), w && (a[l].createMask(), a[l].renderBreaksBackground());
    ...
    F.prototype.calculateStripLinesThicknessInValues = function () {
    ...
    F.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = b || !r(d[f].options.spacing)),
          (d[f].spacing = Ta(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
      ...
      if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
        ...
        for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
          a[d].endValue < this.conversionParameters.minimum ||
            (r(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d),
                      ...
                      "inside" === this.labelPlacement
                        ...
                        : q.y -
                          (("inside" === this.tickPlacement ? 0 : this.tickLength) +
                            ((p.textBlock.height - p.textBlock.fontSize / 2) * Math.cos((Math.PI / 180) * this.labelAngle) + (0 < this.labelAngle ? p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) : 0))))),
                (p.textBlock.x = q.x),
                (p.textBlock.y = q.y)));
        "inside" === this.tickPlacement &&
          this.chart.addEventListener(
          ...
          (p = this._labels[k]),
            p.position < this.viewportMinimum ||
              ...
              (d && 0 !== f++ % 2 && this.labelAutoFit) ||
                (0 === this.labelAngle
                  ? ((p.textBlock.y = q.y),
                    (p.textBlock.x = "inside" === this.labelPlacement ? q.x - p.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5))
                  : ((p.textBlock.y =
                      "inside" === this.labelPlacement
    ...
    F.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], m = [], l = !1, b = 0; b < this.stripLines.length; b++) {
          ...
          k._thicknessType === a &&
            (("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || r(k.value) || isNaN(this.range))) ||
              ("value" === a &&
                ((k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum) || (k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum) || r(k.startValue) || r(k.endValue) || isNaN(this.range))) ||
              h.push(k));
        }
          ...
          if (((k = this.stripLines[b]), (c = this._stripLineLabels[b]), !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range)))) {
            ...
            if ("outside" === c.stripLine.labelPlacement)
              if ((k && ((this.ctx.strokeStyle = k.color), "pixel" === k._thicknessType && (this.ctx.lineWidth = k.thickness)), "bottom" === this._position)) {
                ...
                this.ctx.stroke();
                0 === this.labelAngle
                  ? ((a.x -= c.textBlock.width / 2), (a.y += this.tickLength + c.textBlock.fontSize / 2 + 5))
                ...
                "top" === this._position
                  ? ((n = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
                    ...
                    this.ctx.stroke(),
                    0 === this.labelAngle
                      ? ((a.x -= c.textBlock.width / 2), (a.y -= this.tickLength + c.textBlock.height - c.textBlock.fontSize / 2))
                      : ((a.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin((Math.PI / 180) * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                      ...
                      : ((a.y -= c.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                        (a.x =
                          0 < this.labelAngle
                            ...
                            : a.x - c.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) - this.tickLength)))
                ...
                "bottom" === this._position
                  ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.height - 3),
                    ...
                    a.x - c.textBlock.height > this.chart.plotArea.x1
                      ...
                      : ((c.textBlock.angle = 90), r(k.startValue) ? (a.x += c.textBlock.height - c.textBlock.fontSize / 2) : (a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3)),
                    (a.y =
                      ...
                      for (e = 0; e < m.length; e++)
                        (c = m[e]),
                          "inside" === c.stripLine.labelPlacement &&
                            c.stripLine.showOnTop &&
                            (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore());
                    },
                    c.textBlock
                  ))
    ...
    F.prototype.renderCrosshair = function (a, d) {
    ...
    F.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
            if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
              ...
              for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(e, l), d.lineTo(this.scaleBreaks._appliedBreaks[h].startPixel + c, l), (e = this.scaleBreaks._appliedBreaks[h].endPixel + b);
        ...
        if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
          ...
          else for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(l, e), d.lineTo(l, this.scaleBreaks._appliedBreaks[h].startPixel + b), (e = this.scaleBreaks._appliedBreaks[h].endPixel + c);
    ...
    F.prototype.getApparentDifference = function (a, d, c, b) {
      ...
      if (this.logarithmic) {
        ...
        for (c = r(c) ? Math.abs(d - a) : c, f = 0; f < e.length && !(d < e[f].startValue); f++)
          a > e[f].endValue ||
            (a <= e[f].startValue && d >= e[f].endValue
              ? (c = c - e[f].endValue + e[f].startValue + e[f].size)
              : a > e[f].startValue && d >= e[f].endValue
    ...
    F.prototype.setViewPortRange = function (a, d) {
      ...
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if (this.scaleBreaks)
          for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)
            if (
              ((!r(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue) ||
                (!r(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[b].startValue) ||
                (!r(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue)) &&
              ((!r(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue) ||
                (!r(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[b].endValue) ||
                (!r(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue))
            ) {
        ...
        if ("axisX" === this.type && c) {
          ...
          this.intervalType ||
            (b / 1 <= a
              ...
              : ((this.interval = b / (1 * T.yearDuration) <= a ? 1 : b / (2 * T.yearDuration) <= a ? 2 : b / (4 * T.yearDuration) <= a ? 4 : Math.floor(F.getNiceNumber(b / (a - 1), !0) / T.yearDuration)), (this.intervalType = "year")));
          ...
          0 === this.viewportMaximum &&
            ...
            this.options && "undefined" === typeof this.options.interval && (this.interval = F.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        }
    ...
    F.prototype.calculateLogarithmicAxisParameters = function () {
      var a = this.chart.layoutManager.getFreeSpace(),
      ...
      if (this.scaleBreaks)
        for (l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
          if (
            ((!r(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) ||
              (!r(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue) ||
              (!r(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue)) &&
            ((!r(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue) ||
              (!r(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue) ||
              (!r(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue))
          ) {
      ...
      1 === this.viewportMaximum &&
        ...
        this.options && "undefined" === typeof this.options.interval && ((this.interval = F.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1))), (c = F.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
      if (null === this.minimum || null === this.maximum)
        "axisX" === this.type
    ...
    F.getNiceExponent = function (a, d) {
      ...
      if (0 !== this.spacing || (0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness))) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
          if (
            ...
            "top" === this.scaleBreaks.parent._position ? ((e = this.chart.plotArea.y1), (m = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0)) : ((e = this.chart.plotArea.y2), (m = (this.chart.plotArea.y1 - p / 2 + 0.5) << 0), (a *= -1)),
            ...
            this.ctx.bezierCurveTo(r + f * a, k + a, r + f * a, k + 2 * a, r, k + 3 * a);
            r = h;
            f *= -1;
            this.ctx.lineTo(r, k);
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position ? ((b = this.chart.plotArea.x1), (h = (this.chart.plotArea.x2 + p / 2 + 0.5) << 0)) : ((b = this.chart.plotArea.x2), (h = (this.chart.plotArea.x1 - p / 2 + 0.5) << 0), (a *= -1)),
    ...
    M.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position)
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0), (h = this.chart.plotArea.y1), (m = this.chart.plotArea.y2), (this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: m });
        else if ("left" === this.parent._position || "right" === this.parent._position)
          (h = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0), (e = this.chart.plotArea.x1), (f = this.chart.plotArea.x2), (this.bounds = { x1: e, y1: h - d / 2, x2: f, y2: m + d / 2 });
        this.ctx.moveTo(e, h);
        this.ctx.lineTo(f, m);
        this.ctx.stroke();
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var x = 0; x < this.parent.dataSeries.length; x++)
            (v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[x]), null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
          v = null;
          ...
          if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
            for (var v = Math.abs(a - this.parent.convertValueToPixel(n[x].dataPoint.y[0])), u = 0, s = 0; s < n.length; s++)
              if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (var z = 0; z < n[s].dataPoint.y.length; z++) (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))), u < v && ((v = u), (x = s));
            ...
            for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = (u = 0), s = (x = 0); s < n.length; s++)
              if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))), u < v && ((v = u), (x = s));
            ...
            for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = (y = u = 0), s = 0; s < n.length; s++)
              if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))), u < v && ((v = u), (x = s));
              else
                (y += n[s].dataPoint.y),
                  (C = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x),
                  (C = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[C])),
                  (u = Math.abs(a - this.parent.convertValueToPixel(C))),
                  u < v && ((v = u), (x = s));
          else
            for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = x = u = 0; s < n.length; s++)
              if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))), u < v && ((v = u), (x = s));
              else (u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y))), u < v && ((v = u), (x = s));
          z = n[x];
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
              ...
              k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.y[b] })
                : r(this.options.label)
                ? ea(c ? c : z.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                : this.label;
              ...
              this.value = y;
              k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.y })
                : r(this.options.label)
                ? ea(c ? c : z.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
              ...
              this.value = C;
              k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: C })
                : r(this.options.label)
                ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(z.dataPoint.y) << 0),
                (this.value = z.dataPoint.y),
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.y })
                  : r(this.options.label)
                  ? ea(c ? c : z.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
            ...
            if (C) {
              if ("axisX" === this.parent.type)
                for (s = this.parent.convertPixelToValue({ y: d }), v = null, x = 0; x < this.parent.dataSeries.length; x++)
                  (v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) &&
                    0 <= v.index &&
                    (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label);
            } else
              "dateTime" === this.parent.valueType
                ? (k.text = this.labelFormatter
                    ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.x })
                    : r(this.options.label)
                    ? Aa(z.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
                : "number" === this.parent.valueType &&
                  (k.text = this.labelFormatter
                    ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.x })
                    : r(this.options.label)
                    ? ea(z.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label);
          ...
          for (x = 0; x < this.parent.dataSeries.length; x++)
            (v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && ((v.dataSeries = this.parent.dataSeries[x]), null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
          if (0 === n.length) return;
          n.sort(function (a, b) {
            return a.distance - b.distance;
          ...
          if (C) {
            if ("axisX" === this.parent.type)
              for (s = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)
                (v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) &&
                  0 <= v.index &&
                  (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label);
          } else
          ...
          if (
            ...
            for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), s = u = 0; s < n.length; s++)
              if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) (u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))), u < v && ((v = u), (x = s));
            ...
            for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = y = u = 0; s < n.length; s++)
              if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (z = 0; z < n[s].dataPoint.y.length; z++) (u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[z]))), u < v && ((v = u), (x = s));
          ...
          if (
            ...
            v = Math.abs(d - this.parent.convertValueToPixel(z.dataPoint.y[0]));
            ...
            "waterfall" === this.parent.dataSeries[x].type
              ? ((w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum) << 0),
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z.dataSeries.dataPointEOs[z.index].cumulativeSum })
                  : r(this.options.label)
                  ? ea(c ? c : z.dataSeries.dataPointEOs[z.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo)
                  : this.label),
                (this.value = z.dataSeries.dataPointEOs[z.index].cumulativeSum))
              : ((w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) << 0),
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : z.dataPoint.y })
                  : r(this.options.label)
                  ? ea(c ? c : z.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                  : this.label),
                (this.value = z.dataPoint.y));
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position)
          "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize / 2),
            ...
            b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) &&
              ...
              (0 < p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), (this._hidden = !1)), q.restore());
        if ("left" === this.parent._position || "right" === this.parent._position)
          "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
            ...
            h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) &&
              f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) &&
              (0 < p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), (this._hidden = !1)), q.restore());
      } else {
        if ("bottom" === this.parent._position || "top" === this.parent._position)
          (b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (h = this.chart.plotArea.y2), (this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h });
        else if ("left" === this.parent._position || "right" === this.parent._position)
          (f = h = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          if ("left" === this.parent._position || "right" === this.parent._position) {
            C = !1;
            if (this.parent.labels)
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var v = 0; v < this.chart.axisX.length; v++) {
                for (var h = this.chart.axisX[v].convertPixelToValue({ y: d }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                  (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX[v].dataSeries[b]), null !== k.dataPoint.y && m.push(k));
                k = null;
              }
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++) {
                ...
                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                  (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX2[v].dataSeries[b]), null !== k.dataPoint.y && m.push(k));
                k = null;
              }
          } else {
            m = [];
            if (this.chart.axisX)
              for (v = 0; v < this.chart.axisX.length; v++)
                for (h = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                  (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX[v].dataSeries[b]), null !== k.dataPoint.y && m.push(k));
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++)
                for (h = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                  (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX2[v].dataSeries[b]), null !== k.dataPoint.y && m.push(k));
          }
              ...
              if (k.dataSeries.axisY)
                if (0 < k.dataPoint.y.length) {
                  ...
                  "column" === e.type || "bar" === e.type
                    ...
                    : "bubble" === e.type
                    ? ((c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2), k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - c && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + c && f.push(k))
                    : "waterfall" === e.type
                    ? ((c = 0),
                      ...
                      2 > c && -2 < c && f.push(k))
                    : (0 <= k.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || (k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum)) &&
                      f.push(k);
              else f.push(k);
          }
        }
          ...
          if ((this.highlightObjects(f), this.enabled)) {
            ...
            if (null !== c) {
                    ...
                    "waterfall" === f[0].dataSeries.type
                      ? (this.contentDiv.style.borderRightColor =
                          ...
                          this.contentDiv.style.borderColor =
                            this.options.borderColor ? this.options.borderColor : f[0].dataPoint.color ? f[0].dataPoint.color : 0 < f[0].dataPoint.y ? f[0].dataSeries.risingColor : f[0].dataSeries.fallingColor)
                      : "error" === f[0].dataSeries.type
                      ? (this.contentDiv.style.borderRightColor =
                          this.contentDiv.style.borderLeftColor =
                          this.contentDiv.style.borderColor =
                            this.options.borderColor ? this.options.borderColor : f[0].dataSeries.color ? f[0].dataSeries.color : f[0].dataSeries._colorSet[e.index % f[0].dataSeries._colorSet.length])
                      : (this.contentDiv.style.borderRightColor =
                          this.contentDiv.style.borderLeftColor =
                          this.contentDiv.style.borderColor =
              ...
              d =
                1 !== f.length ||
                this.shared ||
                ("line" !== f[0].dataSeries.type && "stepLine" !== f[0].dataSeries.type && "spline" !== f[0].dataSeries.type && "area" !== f[0].dataSeries.type && "stepArea" !== f[0].dataSeries.type && "splineArea" !== f[0].dataSeries.type)
            ...
            "rangeSplineArea" === b.type
              ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                ...
                "undefined" !== typeof e.y2 &&
                  ...
                  $.drawMarkers([f])))
              : "bubble" === b.type
              ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), $.drawMarkers([f]), (d.globalAlpha = 1))
              : "column" === b.type ||
              ...
              ? W(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
              : "funnel" === b.type || "pyramid" === b.type
              ? oa(d, e.funnelSection, 0.3, "white")
              : "candlestick" === b.type
              ? ((d.globalAlpha = 1),
                ...
                d.stroke(),
                V(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                (d.globalAlpha = 1))
              : "ohlc" === b.type
              ? ((d.globalAlpha = 1),
                (d.strokeStyle = e.color),
              ...
              ? (d.save(),
                ...
                d.restore(),
                (d.globalAlpha = 1))
              : "error" === b.type && x(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
        }
      }
      d.restore();
      d.globalAlpha = 1;
        ...
        for (var m = null, r = "", h = 0; h < a.length; h++)
          (c = a[h].dataSeries),
            ...
            null === b.toolTipContent ||
              ...
              "waterfall" === c.type
                ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += m != c.axisXIndex ? (c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>") : ""),
                  (f += b.toolTipContent
                    ? b.toolTipContent
                    : c.toolTipContent
                    ? c.toolTipContent
              ...
              null === d && (d = ""),
              !0 === this.reversed ? ((d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d), h < a.length - 1 && (d = "</br>" + d)) : ((d += this.chart.replaceKeywordsWithValue(f, b, c, e)), h < a.length - 1 && (d += "</br>")));
        null !== d && (d = r + d);
      } else {
        c = a[0].dataSeries;
        b = a[0].dataPoint;
    ...
    X.prototype.showAtX = function (a, d) {
      ...
      if (this.shared) for (var h = 0; h < this.chart.data.length; h++) (c = this.chart.data[h]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !r(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
      else (c = this.chart.data[d]), (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !r(b.dataPoint.y) && c.visible && ((b.dataSeries = c), f.push(b));
      if (0 < f.length) {
        for (h = 0; h < f.length; h++)
          if (
            ((b = f[h]), b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum)
          )
            e = !0;
          else {
            e = !1;
              ...
              (this.borderColor =
                "waterfall" === f[0].dataSeries.type
                  ...
                  ? (this.contentDiv.style.borderRightColor =
                      this.contentDiv.style.borderLeftColor =
                      this.contentDiv.style.borderColor =
                        this.options.borderColor ? this.options.borderColor : f[0].dataSeries.color ? f[0].dataSeries.color : f[0].dataSeries._colorSet[c.index % f[0].dataSeries._colorSet.length])
                  : (this.contentDiv.style.borderRightColor =
                      this.contentDiv.style.borderLeftColor =
                      this.contentDiv.style.borderColor =
                        this.options.borderColor
      ...
      $ = {
        drawMarker: function (a, d, c, b, e, f, h, m) {
          if (c) {
            ...
            "circle" === b
              ? (c.moveTo(a, d), c.beginPath(), c.arc(a, d, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), m && (h ? c.stroke() : ((r = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = r))))
              : "square" === b
              ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), m && (h ? c.stroke() : ((r = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = r))))
              : "triangle" === b
              ? (c.beginPath(),
                ...
                c.closePath(),
                f && c.fill(),
                m && (h ? c.stroke() : ((r = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = r))),
                c.beginPath())
              : "cross" === b &&
                ((c.strokeStyle = f), (c.lineWidth = e / 4), c.beginPath(), c.moveTo(a - e / 2, d - e / 2), c.lineTo(a + e / 2, d + e / 2), c.stroke(), c.moveTo(a + e / 2, d - e / 2), c.lineTo(a - e / 2, d + e / 2), c.stroke());
          }
        },
